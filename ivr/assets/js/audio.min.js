            ...
            this.each(function () {
                if ("audio" === t(this).prop("tagName").toLowerCase()) {
                    ...
                    if (
                        (u(c)
                            ? (f = !0)
                            : i.find("source").each(function () {
                                  if (u(t(this).attr("src"))) return (f = !0), !1;
                              }),
                        f)
                    ) {
                        var h = t('<div class="ppq-audio-player">' + t("<div>").append(i.eq(0).clone()).html() + '<div class="play-pause-btn"><a href="javascript: void(0);" class="play-pause-icon" style="background:#fff;"></a></div></div>'),
                            b = h.find("audio")[0];
