...
<link rel="shortcut icon" type="image/png" href="<?php echo base_url(); ?>assets/images/favicon.png">
   ...
   <!--
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/style_1.css">
              ...
              <div class="right-side">
                ...
                <form class="" method="post" action="<?php echo base_url('home');?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" data-toggle="tooltip" title="Enter Email Address!">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="pwd" data-toggle="tooltip" title="Enter Password!">
                ...
                <form class="" method="post">
                  ...
                  <div class="container">
                    ...
                    <div class="form-group text-center">
                      ...
                      <!-- <a href="JavaScript:void(0);" id="return">Sign In</a> -->

                      <p>Already have Team365 account? <a href="JavaScript:void(0);" id="return">Sign In</a></p>
