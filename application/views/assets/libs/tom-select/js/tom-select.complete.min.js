...
/**
* Build a completed/highlighted string from input tokens and matches (used by Tom-Select completion).
* @example
* complete("term", undefined, "some text to match")
* "some completed string with matched segments"
* @param {{string}} {{t}} - The primary input or query string to base completion on.
* @param {{*}} {{p}} - Optional processor or options; if undefined it will be computed internally.
* @param {{string}} {{e}} - The source string to scan and match against the query.
* @param {{string}} {{u}} - Fallback value used when t is falsy.
* @returns {{string}} The generated completion string (with matched substrings prepared for rendering).
**/
...
/**
* Create and return a scoring function that evaluates items against search tokens and configured fields.
* @example
* getScoreFunction({ tokens: [{value: 'foo'}], options: { fields: [{field: 'title'}], conjunction: 'or' }, weights: { title: 2 }, getAttrFn: (item, f) => item[f] })
* function(item) { return 0.75 }
* @param {{Object}} {{e}} - Search descriptor with tokens (Array), options (Object), weights (Object) and getAttrFn (Function).
* @returns {{Function}} Return a function that accepts an item and returns a numeric score (0 to 1).
**/
...
/**
* Parse a select or input DOM element and produce a Tom Select configuration object with parsed options, optgroups, and items.
* @example
* ae(element, options)
* {placeholder: "Choose...", options: [{label:"...", value:"...", disabled:false, $option: HTMLElement, $order:1}], optgroups: [{label:"...", value:1, $order:2}], items: ["val1","val2"], maxItems:1}
* @param {{HTMLElement}} {{e}} - The select or input DOM element to parse.
* @param {{Object}} {{t}} - Optional configuration overrides to merge with defaults (e.g., dataAttr, labelField, valueField, disabledField, optgroupField, optgroupLabelField, optgroupValueField, allowEmptyOption, delimiter).
* @returns {{Object}} Return object containing merged defaults and parsed data (placeholder, options, optgroups, items, maxItems, etc.).
**/
...
/**
* Initialize a Tom Select instance on a DOM input or select element.
* @example
* onstructor(document.querySelector('#my-select'), { create: true })
* undefined
* @param {HTMLElement} e - The input or select DOM element to enhance.
* @param {Object} t - Configuration options for the Tom Select instance.
* @returns {void} Does not return a value; initializes the Tom Select instance on the element.
**/
...
/**
* Initialize the select control: build and configure DOM elements, apply ARIA attributes, attach event listeners, initialize plugins, synchronize and update the original input, and finalize setup.
* @example
* etup()
* undefined
...
/**
* Handle keydown events for the control, managing navigation, selection, creation, deletion, open/close and other keyboard interactions.
* @example
* nKeyDown(e)
* undefined
* @param {{KeyboardEvent}} {{e}} - KeyboardEvent from a keydown on the control.
* @returns {{void}} Void.
**/
...
/**
* Refresh the dropdown options and render optgroups, highlights, loading/no_results states, and active option.
* @example
* efreshOptions(true)
* undefined
* @param {boolean} e - Whether to open/allow opening the dropdown after refreshing (default: true).
