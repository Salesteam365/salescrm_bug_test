(function () {
    ...
    let myElement1 = document.getElementById('new-tasks');
    new SimpleBar(myElement1, { autoHide: true });

    let myElement2 = document.getElementById('todo-tasks');
    new SimpleBar(myElement2, { autoHide: true });

    let myElement3 = document.getElementById('inprogress-tasks');
    new SimpleBar(myElement3, { autoHide: true });

    let myElement4 = document.getElementById('inreview-tasks');
    new SimpleBar(myElement4, { autoHide: true });

    let myElement5 = document.getElementById('completed-tasks');
