...
function switcherClick() {
  ...
  let backgroundColor1Var = bgDefaultColor1Btn.addEventListener("click", () => {
    ...
    document.querySelector('html').style.setProperty('--light', "25 35 102");
    document.querySelector('html').style.setProperty('--input-border', "25 35 102");
  ...
  let backgroundColor2Var = bgDefaultColor2Btn.addEventListener("click", () => {
    ...
    html.setAttribute("data-menu-styles", "dark");
    html.setAttribute("data-header-styles", "dark");
    document.querySelector('html').style.setProperty('--light', "13 83 120");
    document.querySelector('html').style.setProperty('--input-border', "13 83 120");
