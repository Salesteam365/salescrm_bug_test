...
var element = document.getElementById("country-sessions");
if (element !== null) {
    element.innerHTML = "";
    var options = {
        series: [
...
/* Impressions Chart */
var element = document.getElementById("analytics-followers");
    if (element !== null) {
    element.innerHTML = "";
    var options = {
        chart: {
...
/* Clicks Chart */
var element = document.getElementById("analytics-views");
if (element !== null) {
  element.innerHTML = "";
    var options = {
        chart: {
