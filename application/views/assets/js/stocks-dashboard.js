...
var element = document.getElementById("total-investments");
if (element !== null) {
    element.innerHTML = "";
    var stocks2 = {
        chart: {
...
var element = document.getElementById("portfolio-value");
if (element !== null) {
    element.innerHTML = "";
    var stocks3 = {
        chart: {
...
/* Returns Rate Chart */
var element = document.getElementById("returns-rate");
if (element !== null) {
    element.innerHTML = "";
    var stocks4 = {
        chart: {
...
/* Market Cap Chart */
var element = document.getElementById("stocks-marketcap");
if (element !== null) {
    element.innerHTML = "";
    var options = {
        series: [{
