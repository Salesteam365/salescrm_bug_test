...
<div class="content-wrapper">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                        <ul class="list-group list-group-horizontal">
							...
							<a href="<?=base_url('debit-note');?>"><div><img src="https://img.icons8.com/ultraviolet/18/000000/circled-left.png"></div>Back</a>
                            </li>
							<?php if($this->session->userdata('update_pi')=='1'): ?>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>add-debitnote/<?=$view_debitnote['invoice_id']?>"><div><img src="https://img.icons8.com/cotton/18/000000/edit--v1.png"></div>Edit Debit Note</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="right-buttons d-flex justify-content-end">
                        <ul class="list-group list-group-horizontal">
						    ...
						    <li class="list-group-item text-center"><a href="<?=base_url();?>Accounting/generate-pdf?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>" target="_blank"><div><img src="https://img.icons8.com/color/18/000000/print.png"/></div>Print</a>
                            </li>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>Accounting/generate-pdf?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>&dn=1" target="_blank"><div><img src="https://img.icons8.com/fluent/20/000000/download.png"/></div>Download</a>
                            </li>
                            ...
                            <li class="list-group-item text-center" onClick="shareEmail();"><a href="#" ><div><img src="https://img.icons8.com/ultraviolet/18/000000/email-open--v1.png"/></div>Email Debit Note</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div id="main" class="content">
        <div class="container-fluid">
            <div class="accordion" id="faq">
                <div class="card">
                    <div class="card-header" id="faqhead1"> <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1"><i class="fas fa-file-alt"></i> Debit Note Summary</a>
                    </div>
                    <div id="faq1" class="collapse show" aria-labelledby="faqhead1" data-parent="#faq">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <b>Debit Note No.</b>
                                    <p><?=$view_debitnote['debitnote_no']?></p>
                                </div>
                                <div class="col">
                                    <b>Customer Name</b>
                                    <p><?=$view_debitnote['org_name']?></p>
                                </div>
                                <div class="col">
                                    <b>Total Amount</b>
									
                                    <p>₹ <?=$view_debitnote['sub_total']?></p>
                                </div>
                                <div class="col">
                                    <b>Customer Balance</b>
									
                                    <p>₹ <?=$view_debitnote['pending_payment']?> (Due)</p>
                                </div>
                                <div class="col">
                                    <b>Debit Note Date</b>
									<p><?php 
									if($view_debitnote['debitnote_date']!=""){
										$date=date_create($view_debitnote['debitnote_date']);
                                ...
                                <div class="col">
                                    <b>Due Date</b>
                                    <p><?php 
									if($view_debitnote['due_date']!=""){
										$date=date_create($view_debitnote['due_date']);
										echo date_format($date,"d F Y");
									}else{ echo "Not Set"; } ?></p>
                                </div>
                                <div class="col">
                                    <b>Other Reference(s)</b>
                                    <p><?=$view_debitnote['owner']?></p>
                                </div>

                                <div class="col">
                                    <b> Supplier's Ref.</b>
                                    <p><?=$view_debitnote['so_owner']?></p>
                                </div>

                                <div class="col">
                                    <b>Buyer's Order No.</b>
                                    <p><?=$view_debitnote['cust_order_no']?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="invoice-type">
        <div class="container">
            <h1>Debit Note</h1><span>Part Paid</span>
            <hr>
            <div class="row mt-3">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
				<?php if(isset($view_debitnote['saleorder_id']) && $view_debitnote['saleorder_id']!=""){?>
					<p>Sales Order ID</p>
				<?php } ?> 
                    <p>Link Invoice No#</p>
                    <p>Debit Note No#</p>
				...
				<?php if(isset($view_debitnote['saleorder_id']) && $view_debitnote['saleorder_id']!=""){ ?>
				    <p><b><?=$view_debitnote['saleorder_id']?></b></p>
				<?php } ?>	
                    <p><b><?=$inov_no['invoice_no']?></b></p>
                    <p><b><?=$view_debitnote['debitnote_no']?></b></p>
                    <p><b>
					<?php $date=date_create($view_debitnote['debitnote_date']);?>
                ...
                <div class="row">
				   <div class="col">
					    <div class="billed-by" style="background:rgba(35, 0, 140, 0.8)">
                            <h3>Billed By</h3>
                            <b><?=$branch_debit['company_name'];?></b>
                            <p><?=$branch_debit['address'];?>, <?=$branch_debit['city'];?>, <?=$branch_debit['state'];?>-<?=$branch_debit['zipcode'];?>, <?=$branch_debit['country'];?></p>
                            <p><b>Email:</b> <?=$branch_debit['branch_debit_email'];?></p>
                            <p><b>Phone:</b> +91-<?=$branch_debit['contact_number'];?></p>
							<p><b>GSTIN: </b> <?=$branch_debit['gstin'];?> </p>
                        </div>
            ...
            <div class="invoice-table mt-3 text-left">
                <div class="row">
                    <div class="col">
                        <p><b>Country of Supply :</b> <?=$branch_debit['country'];?></p>
                    </div>
                    <div class="col">
                        <p><b>Place of Supply :</b> <?=$branch_debit['city'];?> (<?=$branch_debit['zipcode'];?>)</p>
                    </div>
                </div>
                <table class="table table-responsive-lg">
                    <?php 
                	    $igst=explode("<br>",$view_debitnote['igst']);
                    $discount = explode("<br>",$view_debitnote['pro_discount']); ?>
					...
					$totalsGst=0;
					$totalcGst=0;
					if($view_debitnote['product_name']!=""){
						$product_name=explode("<br>",$view_debitnote['product_name']);
						if(!empty($view_debitnote['gst'])){
						$gst=explode("<br>",$view_debitnote['gst']);
						}
						$quantity=explode("<br>",$view_debitnote['quantity']);
						$unit_price=explode("<br>",$view_debitnote['unit_price']);
						$hsnsac = explode("<br>",$view_debitnote['hsn_sac']);
						$total=explode("<br>",$view_debitnote['total']);
						$descriptionPro=explode("<br>",$view_debitnote['pro_description']);
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-6">
                        <div class="bank-total-left">
                            <p>Total In Words: <b>
							<?php  $get_amount= AmountInWords($view_debitnote['sub_total']);
							echo $get_amount;
							?></b></p>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                        <div class="bank-total-right">
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_debitnote['initial_total']);?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col text-right">
                                    (₹ <?=IND_money_format($view_debitnote['total_discount']);?>)
                                </div>
                            </div>
                           
							<?php //if($igst[0]!=""){ ?>
							<?php if($view_debitnote['type']=="Interstate"){ ?>
							<div class="row">
                                <div class="col">
                                    IGST
                                </div>
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_debitnote['total_igst']); ?>
                                </div>
                            </div>
							<?php }else if($view_debitnote['type']=="Instate"){?>
                            <div class="row">
                                <div class="col">
                                    SGST
                                </div>
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_debitnote['total_sgst']);?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_debitnote['total_cgst']);?>
                                </div>
                            </div>
							<?php } ?>
							<?php  if($view_debitnote['extra_charge_value']!=""){ 
							$extraCharge_name=explode("<br>",$view_debitnote['extra_charge_label']);
							$extraCharge_value=explode("<br>",$view_debitnote['extra_charge_value']);
                            ...
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_debitnote['sub_total']);?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="terms-condition">
                ...
                <ol>
				<?php if($view_debitnote['terms_condition']!=""){
					$terms_condition=explode("<br>",$view_debitnote['terms_condition']);
			...
			<div class="terms-condition">
				<div class="row">
					...
					<div class="col">
						<div class="details-switch">
							<label class="switch">
								<input type="checkbox" id="slider_declaration" onchange="enable_declaration('<?=$view_debitnote['id'];?>')" name="slider_declaration" <?php if($view_debitnote['declaration_status']==1){ echo "checked"; } ?> >
				...
				<div class="row">
					<?php if($view_debitnote['invoice_declaration']!=""){ echo $view_debitnote['invoice_declaration']; } ?>
				</div>
			...
			<div class="terms-condition">
                <p><b>Note :-</b> </p>
				<?php if($view_debitnote['notes']!=""){ echo $view_debitnote['notes']; } ?>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                         <ul class="list-group list-group-horizontal">
							...
							<?php if($this->session->userdata('update_pi')=='1'): ?>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>add-debitnote/<?=$view_debitnote['invoice_id']?>"><div><img src="https://img.icons8.com/cotton/18/000000/edit--v1.png"></div>Edit Invoice</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
...
.lbl{
 ...
 <div class="modal fade" id="branch_debit_details" data-keyboard="false" data-backdrop="static">
          ...
          <div class="row">
			...
			<div class="col-md-6">
			 <div class="row text-center " style="padding-top: 5%;">
			  ...
			  <div class="col-md-4">
			   <?php $actual_link = base_url()."Accounting/generate-pdf?inv_id=".$_GET['inv_id']."&cnp=".$_GET['cnp']."&ceml=".$_GET['ceml']; ?>
 ...
 <div class="modal fade" id="emailModel" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title">Email Debit Note</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
       <input type="hidden" class="form-control" value="<?=$view_debitnote['id'];?>" id="piid">
	   <input type="hidden" class="form-control" value="<?=$view_debitnote['session_comp_email'];?>" id="compeml">
		<input type="hidden" class="form-control" value="<?=$view_debitnote['session_company'];?>" id="compname">
      <div class="modal-body" style="padding: 5%;">
          <div class="row" id="formDiv">
			...
			<div class="col-md-10">
			  <input type="text" class="form-control" value="<?=$branch_debit['branch_debit_email'];?>" name="ccEmail" id="ccEmail">
            </div>
			<div class="col-md-2 lbl">
				<label for="">Subject:</label>
			</div>
			<div class="col-md-10">
			  <input type="text" class="form-control" value="Invoices For <?=$clientDtl->org_name;?> - #<?=$view_debitnote['debitnote_no'];?>" name="subEmail" id="subEmail">
            </div>
			<div class="col-md-12 lbl">
				<label for="">Message*:</label>
			</div>
			<div class="col-md-12" style="font-size: 11px; margin: 3px 0px;">
				Debit Note PDF attachment and Online Link will be added to the email automatically.
			</div>
			
			<div class="col-md-12">
			  <textarea class="form-control" id="descriptionTxt"   name="descriptionTxt">
				<p>Hi <?=$clientDtl->org_name;?>,</p>
				<p>Please find attached debit note #<?=$view_debitnote['debitnote_no'];?>.</p>
				<p>Debit Note No: #<?=$view_debitnote['debitnote_no'];?></p>
				<p>Billed To: <?=$clientDtl->org_name;?></p>
				<p>Total Amount: ₹ <?=IND_money_format($view_debitnote['sub_total']);?></p>
				<p>Thank you for your business.</p>
				<p>Regards ,</p>
				<p><?=$branch_debit['company_name'];?>, <?=$branch_debit['branch_debit_name'];?></p>
			  </textarea>
            </div>
          </div>
			...
			<div class="row" id="footerDiv">
				<div class="col-md-10" style="padding-top: 5%;">
					<i class="fas fa-info-circle"></i>&nbsp;&nbsp;Note: Anyone with the link can view this Debit Note.
				</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form">
                  <form action="#" id="payment_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                    <input type="hidden"  name="sales_id" id="sales_id" value="<?php echo $view_debitnote['saleorder_id'];?>" >
					<input type="hidden"   name="inv_id" id="inv_id" value="<?php echo $view_debitnote['id'];?>" >
...
function update_billedby(id){ 
	$('#branch_debit_details').modal('show'); 
}

function shareEmail(){ 
    $('#branch_debit_details').modal('hide'); 
