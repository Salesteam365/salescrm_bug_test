...
<div class="content-wrapper">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                        <ul class="list-group list-group-horizontal">
							...
							<a href="<?=base_url('delivery-Chalan');?>"><div><img src="https://img.icons8.com/ultraviolet/18/000000/circled-left.png"></div>Back</a>
                            </li>
							<?php if($this->session->userdata('update_pi')=='1'): ?>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>add-deliverychallan/<?=$view_deliverychallan['invoice_id']?>"><div><img src="https://img.icons8.com/cotton/18/000000/edit--v1.png"></div>Edit Delivery Challan</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="right-buttons d-flex justify-content-end">
                        <ul class="list-group list-group-horizontal">
                            ...
                            <li class="list-group-item text-center" onClick="shareEmail();"><a href="#" ><div><img src="https://img.icons8.com/ultraviolet/18/000000/email-open--v1.png"/></div>Email Delivery Challan </a>
                            </li>
                        </ul>
                    </div>
                </div>
     ...
     <div id="main" class="content">
        <div class="container-fluid">
            <div class="accordion" id="faq">
                <div class="card">
                    <div class="card-header" id="faqhead1"> <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1" style="background:rgba(230,242,255,0.4); color:black;"> <img src="https://img.icons8.com/plasticine/24/000000/invoice-1.png"/>Quick Delivery Challan Detail</a>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p><?=$view_deliverychallan['deliverychallan_no']?></p>
                                </div>
                                <div class="col">
                                    <b>Customer Name</b>
                                ...
                                <div class="col">
                                    ...
                                    <p>₹ <?=IND_money_format($view_deliverychallan['sub_total']);?></p>
                                </div>
                                <div class="col">
                                    <b>Customer Blanace</b>
									
                                    <p>₹ <?=IND_money_format($view_deliverychallan['pending_payment']);?></p>
                                </div>
                                <div class="col">
                                    <b>Delivery Challan Date</b>
									<?php 
									$date=date_create($view_deliverychallan['deliverychallan_date']);?>
                                    <p><?=date_format($date,"d M Y");?></p>
                                </div>
                                <div class="col">
                                    <b>Due Date</b>
                                    <p><?php 
									if($view_deliverychallan['due_date']!=""){
										$date=date_create($view_deliverychallan['due_date']);
										echo date_format($date,"d F Y");
									}else{ echo "Not Set"; } ?></p>
                                </div>
                                <div class="col">
                                    <b>Other Reference(s)</b>
                                    <p><?=$view_deliverychallan['owner'];?></p>
                                </div>
								<div class="col">
                                    <b>Supplier's Ref.</b>
                                    <p><?=$view_deliverychallan['so_owner'];?></p>
                                </div>
								<div class="col">
                                    <b>Buyer's Order No.</b>
                                    <p><?=$view_deliverychallan['cust_order_no'];?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="invoice-type">
        <div class="container">
            <h1>Delivery Challan </h1><span>Part Paid</span>
            <hr>
         
            <div class="row mt-3">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
				<?php if(isset($view_deliverychallan['saleorder_id']) && $view_deliverychallan['saleorder_id']!=""){?>
					<p>Sales Order ID</p>
				<?php } ?> 
                    <p>Link Invoice No#</p>
				...
				<?php if(isset($view_deliverychallan['saleorder_id']) && $view_deliverychallan['saleorder_id']!=""){ ?>
				    <p><b><?=$view_deliverychallan['saleorder_id']?></b></p>
				<?php } ?>	
                    <p><b><?=$inov_no['invoice_no']?></b></p>
                    <p><b><?=$view_deliverychallan['deliverychallan_no']?></b></p>
                    <p><b>
					<?php $date=date_create($view_deliverychallan['deliverychallan_date']);?>
            ...
            <div class="invoice-table mt-3 text-left">
                ...
                <table class="table table-responsive-lg">
                    <?php 
                	    $igst=explode("<br>",$view_deliverychallan['igst']);
                    $discount = explode("<br>",$view_deliverychallan['pro_discount']); ?>
					...
					$totalsGst=0;
					$totalcGst=0;
					if($view_deliverychallan['product_name']!=""){
						$product_name=explode("<br>",$view_deliverychallan['product_name']);
						if(!empty($view_deliverychallan['gst'])){
						$gst=explode("<br>",$view_deliverychallan['gst']);
						}
						$quantity=explode("<br>",$view_deliverychallan['quantity']);
						$unit_price=explode("<br>",$view_deliverychallan['unit_price']);
						$hsnsac = explode("<br>",$view_deliverychallan['hsn_sac']);
						$total=explode("<br>",$view_deliverychallan['total']);
						$descriptionPro=explode("<br>",$view_deliverychallan['pro_description']);
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-6">
                        <div class="bank-total-left">
                            <p>Total In Words: <b>
							<?php  $get_amount= AmountInWords($view_deliverychallan['sub_total']);
							echo $get_amount;
							?></b></p>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                        <div class="bank-total-right">
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_deliverychallan['initial_total']);?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col text-right">
                                    (₹ <?=IND_money_format($view_deliverychallan['total_discount']);?>)
                                </div>
                            </div>
                           
							<?php //if($igst[0]!=""){ ?>
							<?php if($view_deliverychallan['type']=="Interstate"){ ?>
							<div class="row">
                                <div class="col">
                                    IGST
                                </div>
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_deliverychallan['total_igst']); ?>
                                </div>
                            </div>
							<?php }else if($view_deliverychallan['type']=="Instate"){?>
                            <div class="row">
                                <div class="col">
                                    SGST
                                </div>
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_deliverychallan['total_sgst']);?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_deliverychallan['total_cgst']);?>
                                </div>
                            </div>
							<?php } ?>
							<?php  if($view_deliverychallan['extra_charge_value']!=""){ 
							$extraCharge_name=explode("<br>",$view_deliverychallan['extra_charge_label']);
							$extraCharge_value=explode("<br>",$view_deliverychallan['extra_charge_value']);
                            ...
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_deliverychallan['sub_total']);?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="terms-condition">
                ...
                <ol>
				<?php if($view_deliverychallan['terms_condition']!=""){
					$terms_condition=explode("<br>",$view_deliverychallan['terms_condition']);
			...
			<div class="terms-condition">
				<div class="row">
					...
					<div class="col">
						<div class="details-switch">
							<label class="switch">
								<input type="checkbox" id="slider_declaration" onchange="enable_declaration('<?=$view_deliverychallan['id'];?>')" name="slider_declaration" <?php if($view_deliverychallan['declaration_status']==1){ echo "checked"; } ?> >
				...
				<div class="row">
					<?php if($view_deliverychallan['invoice_declaration']!=""){ echo $view_deliverychallan['invoice_declaration']; } ?>
				</div>
			...
			<div class="terms-condition">
                <p><b>Note :-</b> </p>
				<?php if($view_deliverychallan['notes']!=""){ echo $view_deliverychallan['notes']; } ?>
                </ol>
            </div>
        </div>
    </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
       ...
       <input type="hidden" class="form-control" value="<?=$view_deliverychallan['id'];?>" id="piid">
	   <input type="hidden" class="form-control" value="<?=$view_deliverychallan['session_comp_email'];?>" id="compeml">
		<input type="hidden" class="form-control" value="<?=$view_deliverychallan['session_company'];?>" id="compname">
      <div class="modal-body" style="padding: 5%;">
          <div class="row" id="formDiv">
			...
			<div class="col-md-10">
			  <input type="text" class="form-control" value="Invoices For <?=$clientDtl->org_name;?> - #<?=$view_deliverychallan['creditnote_no'];?>" name="subEmail" id="subEmail">
            </div>
			...
			<div class="col-md-12">
			  <textarea class="form-control" id="descriptionTxt"   name="descriptionTxt">
				...
				<p>Please find attached invoice #<?=$view_deliverychallan['creditnote_no'];?>.</p>
				<p>Invoice No: #<?=$view_deliverychallan['creditnote_no'];?></p>
				<p>Billed To: <?=$clientDtl->org_name;?></p>
				<p>Total Amount: ₹ <?=IND_money_format($view_deliverychallan['sub_total']);?></p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form">
                  <form action="#" id="payment_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                    <input type="hidden"  name="sales_id" id="sales_id" value="<?php echo $view_deliverychallan['saleorder_id'];?>" >
					<input type="hidden"   name="inv_id" id="inv_id" value="<?php echo $view_deliverychallan['id'];?>" >
