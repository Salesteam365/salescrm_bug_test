    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6 offset-sm-1">
          <h1 class="m-0 text-dark text-right" style="-webkit-text-fill-color: unset;"><?php if(isset($action['data']) && $action['data']=='update'){ echo "Update"; }else{ echo "Generate "; } ?>Delivery Challan</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-5">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
             ...
             <li class="breadcrumb-item">
                 <a href="<?php echo base_url()."delivery-Chalan "; ?>">Delivery Challan</a>
            </li>
            <li class="breadcrumb-item active"><?php if(isset($action['data']) && $action['data']=='update'){ echo "Update"; }else{ echo "Add"; } ?> Delivery Challan</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
    ...
    <div class="container">
	  <div class="invoice-section">
	   ...
	   if(isset($action['data']) && $action['data']=='update'){ 
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				 <div class="form-group">
					<label for="">Delivery Challan No.<span style="color: #f76c6c;">*</span>:</label>
					<input type="text" class="form-control" name="deliverychallan_no" placeholder="Buyer's Order No" id="deliverychallan_no" value="<?php echo $creditnotenum;?>">
					<span id="invoice_no_error"></span>
				 </div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="form-group">
					<label for="">Delivery Challan Date<span style="color: #f76c6c;">*</span>:</label>
					<input type="date" class="form-control" name="deliverychallan_date" placeholder="Buyer's Order Date (MM/DD/YYYY)" id="deliverychallan_date" value="<?php echo date('Y-m-d');?>" >
...
function save(){
	if(checkValidationWithClass('form_invoice')==1){
			...
			if(save_method == 'add') {
				url = "<?= site_url('Accounting/add_deliveryDetails')?>";
			} else {
				url = "<?= site_url('Accounting/update_deliveryDetails')?>";
			}
			...
			$.ajax({
				...
				{ 
				  if(data.status) 
				  {
					...
					window.location.href = '<?=base_url()?>Accounting/view-deliverychallan'+data.id;   
				  }else{
				  ...
				  window.location.href = '<?php echo base_url("delivery-Chalan"); ?>';
				},
