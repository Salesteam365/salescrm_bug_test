...
<div class="content-wrapper">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                        <ul class="list-group list-group-horizontal">
							...
							<a href="<?=base_url('payment-reciept');?>"><div><img src="https://img.icons8.com/ultraviolet/18/000000/circled-left.png"></div>Back</a>
                            </li>
							<!-- <?php if($this->session->userdata('update_pi')=='1'): ?>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>add-creditnote/<?=$view_paymentreceipt['invoice_id']?>"><div><img src="https://img.icons8.com/cotton/18/000000/edit--v1.png"></div>Edit Credit Note</a>
                            </li>
                            <?php endif; ?> -->
                        </ul>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="right-buttons d-flex justify-content-end">
                        <ul class="list-group list-group-horizontal">
						    ...
						    <li class="list-group-item text-center"><a href="<?=base_url();?>Accounting/generate-pdf-paymentreceipt?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>" target="_blank"><div><img src="https://img.icons8.com/color/18/000000/print.png"/></div>Print</a>
                            </li>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>Accounting/generate-pdf-paymentreceipt?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>&dn=1" target="_blank"><div><img src="https://img.icons8.com/fluent/20/000000/download.png"/></div>Download</a>
                            </li>
                            ...
                            <li class="list-group-item text-center" onClick="shareEmail();"><a href="#" ><div><img src="https://img.icons8.com/ultraviolet/18/000000/email-open--v1.png"/></div>Email Payment receipt</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div id="faq1" class="collapse show" aria-labelledby="faqhead1" data-parent="#faq">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <b>Invoice</b>
                                    <p><?=$view_paymentreceipt['creditnote_no']?></p>
                                </div>
                                <div class="col">
                                    <b>Customer Name</b>
                                ...
                                <div class="col">
                                    ...
                                    <p>₹ <?=IND_money_format($view_paymentreceipt['sub_total']);?></p>
                                </div>
                                <div class="col">
                                    <b>Invoice Date</b>
									<?php 
									$date=date_create($view_paymentreceipt['creditnote_date']);?>
                                    <p><?=date_format($date,"d M Y");?></p>
                                </div>
                                <div class="col">
                                    <b>Due Date</b>
                                    <p><?php 
									if($view_paymentreceipt['due_date']!=""){
										$date=date_create($view_paymentreceipt['due_date']);
										echo date_format($date,"d F Y");
									}else{ echo "Not Set"; } ?></p>
                                </div>
                                <div class="col">
                                    <b>Other Reference(s)</b>
                                    <p><?=$view_paymentreceipt['owner'];?></p>
                                </div>
								<div class="col">
                                    <b>Supplier's Ref.</b>
                                    <p><?=$view_paymentreceipt['so_owner'];?></p>
                                </div>
								<div class="col">
                                    <b>Buyer's Order No.</b>
                                    <p><?=$view_paymentreceipt['cust_order_no'];?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="invoice-type">
        <div class="container">
            ...
            <div class="row mt-3">
				...
				<?php if(isset($view_paymentreceipt['saleorder_id']) && $view_paymentreceipt['saleorder_id']!=""){?>
					<p>Sales Order ID</p>
				<?php } ?> 
                    <!-- <p>Link Invoice No#</p> -->
                    <p>Payment Reciept No#</p>
                    <p>Payment Reciept Date</p>
                </div>
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-6">
				<?php if(isset($view_paymentreceipt['saleorder_id']) && $view_paymentreceipt['saleorder_id']!=""){ ?>
				    <p><b><?=$view_paymentreceipt['saleorder_id']?></b></p>
				<?php } ?>	
                    <p><b><?=$inov_no['invoice_no']?></b></p>
                    <p><b><?=$view_paymentreceipt['paymentreceipt_no']?></b></p>
                    <p><b>
					<?php $date=date_create($view_paymentreceipt['paymentreceipt_date']);?>
            ...
            <!-- <div class="invoice-table mt-3 text-left">
                ...
                <table class="table table-responsive-lg">
                    <?php 
                	    $igst=explode("<br>",$view_paymentreceipt['igst']);
                    $discount = explode("<br>",$view_paymentreceipt['pro_discount']); ?>
					...
					$totalsGst=0;
					$totalcGst=0;
					if($view_paymentreceipt['product_name']!=""){
						$product_name=explode("<br>",$view_paymentreceipt['product_name']);
						if(!empty($view_paymentreceipt['gst'])){
						$gst=explode("<br>",$view_paymentreceipt['gst']);
						}
						$quantity=explode("<br>",$view_paymentreceipt['quantity']);
						$unit_price=explode("<br>",$view_paymentreceipt['unit_price']);
						$hsnsac = explode("<br>",$view_paymentreceipt['hsn_sac']);
						$total=explode("<br>",$view_paymentreceipt['total']);
						$descriptionPro=explode("<br>",$view_paymentreceipt['pro_description']);
                ...
                <?php if (!empty($view_paymentreceipt['pi_invoice_no_select'])): ?>
                    <div class="invoice-table mt-3 text-left">
                        <div class = "row">
                            <div class="col">
                                <p><b>Payment Summary :</p>
                            </div>

                        </div>
                        <div class = "row">
                            <table class = "table table-responsive-lg"> <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                            ...
                                            <?php foreach ($paymentmethod as $method): 
                                                $totalAmount += $method['amount_received']; 
                                                $Transaction_charge += $method['transaction_charge']; 
                                                $Tds_Withheld += $method['tds_Withheld']; 
                                                $row_sum = $method['amount_received'] + $method['transaction_charge'] + $method['tds_Withheld']; 
                                                $row_sum_Total += $row_sum; 
                                                ?>
                                                
                                                <tr>
                                                    <td><?= $method['payment_method'] ?></td>
                                                    <td><?= $method['amount_received'] ?></td>
                                                    <td><?= $method['transaction_charge'] ?></td>
                                                    <td><?= $method['tds_Withheld'] ?></td>
                                                    <td><?= $row_sum ?></td>
                            ...
                            <div class="row">
                                <div class="col-xl-7 col-lg-7 col-md-7 col-sm-6 col-6">
                                    <div class="bank-total-left">
                                        <p>Total In Words: <b>
                                        <?php  $get_amount= AmountInWords($row_sum_Total);
                                        echo $get_amount;
                                        ?></b></p>
                                    </div> &nbsp;
                                ...
                                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-6">&nbsp;
                                    <div class="bank-total-right">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col text-right">
                                                ₹ <?=IND_money_format($row_sum_Total); ?>
                                            </div>
                                        </div>
                ...
                <div class="invoice-table mt-3 text-left">
                    <div class="row">
                        <div class="col">
                            <p><b>Settled Invoices :<span>Partially Paid</span></p>
                        </div>
                    ...
                    <div class ="row">
                        <table class="table table-responsive-lg">
                            <thead style="background:rgba(35, 0, 140, 0.8)">
                                <tr>
                                    <th style="width:40%;">Invoices No.</th>
                            ...
                            <tbody>
                                <tr>
                                    <?php   $settle_amountb = round($view_paymentreceipt['pending_payment'] - $view_paymentreceipt['sub_total'], 2);
                                    $settle_amountb_formatted = number_format($settle_amountb, 2);?>
                                    <td><?=$view_paymentreceipt['invoice_no'];?></td>
                                    <td><?=$view_paymentreceipt['sub_total'];?> </td>
                                    <td><?=$view_paymentreceipt['TotalAmountReceived'];?></td>
                                    <td><?=$view_paymentreceipt['TotalAmountReceived'];?></td> 
                                    <td><?=$settle_amountb_formatted ;?></td> 
                                </tr>
                            </tbody>
                        ...
                        <div class="bank-total">
                            <div class="row">
                                <div class="col-xl-7 col-lg-7 col-md-7 col-sm-6 col-6">
                                    <div class="bank-total-left">
                                        <p>Total In Words: <b>
                                        <?php  $getino_amount= AmountInWords($view_paymentreceipt['TotalAmountReceived']);
                                        echo $getino_amount;
                                        ?></b></p>
                                    </div>&nbsp;
                                ...
                                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-6"> &nbsp;
                                    <div class="bank-total-right">
                                        <div class="row">
                                            ...
                                            <div class="col text-right">
                                                ₹ <?=IND_money_format($view_paymentreceipt['TotalAmountReceived']);?>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                            ...
                                            <div class="col text-right">
                                                ₹ <?=IND_money_format($settle_amountb_formatted);?>
                                            </div>
                                        </div>
            ...
            <!-- <div class="bank-total">
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-6">
                        <div class="bank-total-left">
                            <p>Total In Words: <b>
							<?php  $get_amount= AmountInWords($view_paymentreceipt['sub_total']);
							echo $get_amount;
							?></b></p>
                        </div>
						<?php if(isset($bank_details_terms) && $bank_details_terms->enable_payment==1){ ?>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                        <div class="bank-total-right">
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_paymentreceipt['initial_total']);?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col text-right">
                                    (₹ <?=IND_money_format($view_paymentreceipt['total_discount']);?>)
                                </div>
                            </div>
                           
							<?php //if($igst[0]!=""){ ?>
							<?php if($view_paymentreceipt['type']=="Interstate"){ ?>
							<div class="row">
                                <div class="col">
                                    IGST
                                </div>
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_paymentreceipt['total_igst']); ?>
                                </div>
                            </div>
							<?php }else if($view_paymentreceipt['type']=="Instate"){?>
                            <div class="row">
                                <div class="col">
                                    SGST
                                </div>
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_paymentreceipt['total_sgst']);?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_paymentreceipt['total_cgst']);?>
                                </div>
                            </div>
							<?php } ?>
							<?php  if($view_paymentreceipt['extra_charge_value']!=""){ 
							$extraCharge_name=explode("<br>",$view_paymentreceipt['extra_charge_label']);
							$extraCharge_value=explode("<br>",$view_paymentreceipt['extra_charge_value']);
                            ...
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_paymentreceipt['sub_total']);?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="terms-condition">
                ...
                <ol>
				<?php if($view_paymentreceipt['terms_condition']!=""){
					$terms_condition=explode("<br>",$view_paymentreceipt['terms_condition']);
			...
			<div class="terms-condition">
				<div class="row">
					...
					<div class="col">
						<div class="details-switch">
							<label class="switch">
								<input type="checkbox" id="slider_declaration" onchange="enable_declaration('<?=$view_paymentreceipt['id'];?>')" name="slider_declaration" <?php if($view_paymentreceipt['declaration_status']==1){ echo "checked"; } ?> >
				...
				<div class="row">
					<?php if($view_paymentreceipt['invoice_declaration']!=""){ echo $view_paymentreceipt['invoice_declaration']; } ?>
				</div>
			...
			<div class="terms-condition">
                <p><b>Note :-</b> </p>
				<?php if($view_paymentreceipt['p_notes']!=""){ echo $view_paymentreceipt['p_notes']; } ?>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div id="main" class="content">
        <div class="container-fluid">
            <div class="accordion" id="faq">
                <div class="card">
                    <div class="card-header" id="faqhead1"> <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1"><i class="fas fa-file-alt"></i> Payment Records</a>
                    </div>
                                ...
                                <table class="table table-responsive">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="2">Payment Account</th>
                                        ...
                                        <?php foreach ($paymentmethod as $method): ?>
                                            ...
                                            <tbody>
                                        <tr>
                                            <td colspan="2"><?php $date = date_create($method['paymentreceipt_date']); echo date_format($date, "d M Y"); ?></td>
                                            <td colspan="2"><?= $method['payment_method'] ?></td>
                                            <td colspan="3"><?= $method['deposited_to'] ?></td>
                                            <td colspan="2"><?= $method['amount_received'] ?></td>
                                            <td colspan="1"><?= $method['ref_id'] ?></td>
                                            <td colspan="2"><?= $method['additional_notes'] ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php endif ?>
                                    </tbody>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
       ...
       <input type="hidden" class="form-control" value="<?=$view_paymentreceipt['id'];?>" id="piid">
	   <input type="hidden" class="form-control" value="<?=$view_paymentreceipt['session_comp_email'];?>" id="compeml">
		<input type="hidden" class="form-control" value="<?=$view_paymentreceipt['session_company'];?>" id="compname">
      <div class="modal-body" style="padding: 5%;">
          <div class="row" id="formDiv">
			...
			<div class="col-md-10">
			  <input type="text" class="form-control" value="Invoices For <?=$clientDtl->org_name;?> - #<?=$view_paymentreceipt['creditnote_no'];?>" name="subEmail" id="subEmail">
            </div>
			...
			<div class="col-md-12">
			  <textarea class="form-control" id="descriptionTxt"   name="descriptionTxt">
				...
				<p>Please find attached invoice #<?=$view_paymentreceipt['creditnote_no'];?>.</p>
				<p>Invoice No: #<?=$view_paymentreceipt['creditnote_no'];?></p>
				<p>Billed To: <?=$clientDtl->org_name;?></p>
				<p>Total Amount: ₹ <?=IND_money_format($view_paymentreceipt['sub_total']);?></p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form">
                  <form action="#" id="payment_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                    <input type="hidden"  name="sales_id" id="sales_id" value="<?php echo $view_paymentreceipt['saleorder_id'];?>" >
					<input type="hidden"   name="inv_id" id="inv_id" value="<?php echo $view_paymentreceipt['id'];?>" >
