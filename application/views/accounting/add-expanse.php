    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6 offset-sm-1">
          <h1 class="m-0 text-dark text-right" style="-webkit-text-fill-color: unset;"><?php if(isset($action['data']) && $action['data']=='update'){ echo "Update"; }else{ echo "Generate"; } ?> Expanditure</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-5">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
             ...
             <li class="breadcrumb-item">
                 <a href="<?php echo base_url()."expanse-manage "; ?>">Expanse Manage</a>
            </li>
            <li class="breadcrumb-item active"><?php if(isset($action['data']) && $action['data']=='update'){ echo "Update"; }else{ echo "Add"; } ?> Expanses</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
  ...
  <div class="form-proforma">
    <div class="container">
	  <div class="invoice-section">
	   <div class="row">
			<input type="hidden"  name="po_id"  id="po_id" value="<?php if(!empty($this->uri->segment(2))){ echo $this->uri->segment(2); }?>">
	   ...
	   if(isset($action['data']) && $action['data']=='update'){ 
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				 <div class="form-group">
					<label for="">Expenditure No.<span style="color: #f76c6c;">*</span>:</label>
					<input type="text" class="form-control" name="expenditure_no" placeholder="Expanse No" id="expenditure_no" value="<?php echo $creditnotenum;?>">
					<span id="expanse_no_error"></span>
				 </div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="form-group">
					<label for="">Expenditure Date<span style="color: #f76c6c;">*</span>:</label>
					<input type="date" class="form-control" name="expenditure_date" placeholder="Expanse Date (MM/DD/YYYY)" id="expenditure_date" value="<?php echo date('Y-m-d');?>" >
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				 <div class="form-group">
					<label for="">PO No.<span style="color: #f76c6c;">*</span>:</label>
					<input type="text" class="form-control" name="po_no" placeholder="Po No" id="po_no" value="<?php if(isset($record['purchaseorder_id'])){ echo $record['purchaseorder_id']; }  ?>">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="form-group">
					<label for="">PO Date<span style="color: #f76c6c;">*</span>:</label>
					<input type="date" class="form-control" name="po_date" placeholder="(MM/DD/YYYY)" id="datepicker" value="<?php if(isset($record['currentdate'])){ echo $record['currentdate']; }  ?>" >
					<span id="invoice_date_error"></span>
				</div>
			</div>
...
function save(){
	...
	if(checkValidationWithClass('form_invoice')==1){
			...
			if(save_method == 'add') {
				url = "<?= site_url('Accounting/add_expanseDetails')?>";
			} else {
				url = "<?= site_url('Accounting/update_expanseDetails')?>";
			}
			...
			$.ajax({
				...
				{ 
				  if(data.status) 
				  {
				    toastr.success('Expenditure has been added successfully.');
					window.location.href = '<?=base_url()?>Accounting/view-expanse'+data.id;   
				  }else{
				  ...
				  window.location.href = '<?php echo base_url("expanse-manage"); ?>';
				},
