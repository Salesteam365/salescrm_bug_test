...
<div class="content-wrapper">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                        <ul class="list-group list-group-horizontal">
							...
							<a href="<?=base_url('expanse-manage');?>"><div><img src="https://img.icons8.com/ultraviolet/18/000000/circled-left.png"></div>Back</a>
                            </li>
							<?php if($this->session->userdata('update_pi')=='1'): ?>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>add-expanse/<?=$view_expenditure['po_id']?>"><div><img src="https://img.icons8.com/cotton/18/000000/edit--v1.png"></div>Edit Expenditure</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="right-buttons d-flex justify-content-end">
                        <ul class="list-group list-group-horizontal">
						    ...
						    <li class="list-group-item text-center"><a href="<?=base_url();?>Accounting/generate-pdf-expanse?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>" target="_blank"><div><img src="https://img.icons8.com/color/18/000000/print.png"/></div>Print</a>
                            </li>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>Accounting/generate-pdf-expanse?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>&dn=1" target="_blank"><div><img src="https://img.icons8.com/fluent/20/000000/download.png"/></div>Download</a>
                            </li>
                            ...
                            <li class="list-group-item text-center" onClick="shareEmail();"><a href="#" ><div><img src="https://img.icons8.com/ultraviolet/18/000000/email-open--v1.png"/></div>Email Expenditure </a>
                            </li>
                        </ul>
                    </div>
                </div>
     ...
     <div id="main" class="content">
        <div class="container-fluid">
            <div class="accordion" id="faq">
                <div class="card">
                    <div class="card-header" id="faqhead1"> <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1" style="background:rgba(230,242,255,0.4); color:black;"> <img src="https://img.icons8.com/plasticine/24/000000/invoice-1.png"/>Quick Expenditure Detail</a>
                    </div>
                    <div id="faq1" class="collapse show" aria-labelledby="faqhead1" data-parent="#faq">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <b>Expenditure No.</b>
                                    <p><?=$view_expenditure['expenditure_no']?></p>
                                </div>
                                <div class="col">
                                    <b>Customer Name</b>
                                ...
                                <div class="col">
                                    ...
                                    <p>₹ <?=IND_money_format($view_expenditure['sub_total']);?></p>
                                </div>
                                <div class="col">
                                    <b>Customer Balance</b>
									
                                    <p>₹ <?=IND_money_format($view_expenditure['pending_payment']);?> (Due)</p>
                                </div>
                                <div class="col">
                                    <b>Expenditure Date</b>
									<?php 
									$date=date_create($view_expenditure['expenditure_date']);?>
                                    <p><?=date_format($date,"d M Y");?></p>
                                </div>
                                <div class="col">
                                    <b>Po Date</b>
                                    <p><?php 
									if($view_expenditure['po_date']!=""){
										$date=date_create($view_expenditure['po_date']);
										echo date_format($date,"d F Y");
									}else{ echo "Not Set"; } ?></p>
                                </div>
                                <div class="col">
                                    <b>Other Reference(s)</b>
                                    <p><?=$view_expenditure['owner'];?></p>
                                </div>
								<div class="col">
                                    <b>Supplier's Ref.</b>
                                    <p><?=$view_expenditure['so_owner'];?></p>
                                </div>
								<div class="col">
                                    <b>Buyer's Order No.</b>
                                    <p><?=$view_expenditure['cust_order_no'];?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="invoice-type">
        <div class="container">
            <h1>Expenditure </h1><span>Part Paid</span>
            <hr>
         
            <div class="row mt-3">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
				<?php if(isset($view_expenditure['saleorder_id']) && $view_expenditure['saleorder_id']!=""){?>
					<p>Sales Order ID</p>
				<?php } ?> 
                    <p>Link Po No#</p>
                    <p>Expenditure No#</p>
                    <p>Expenditure Date</p>
                </div>
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-6">
				<?php if(isset($view_expenditure['saleorder_id']) && $view_expenditure['saleorder_id']!=""){ ?>
				    <p><b><?=$view_expenditure['saleorder_id']?></b></p>
				<?php } ?>	
                    <p><b><?=$inov_no['purchaseorder_id']?></b></p>
                    <p><b><?=$view_expenditure['expenditure_no']?></b></p>
                    <p><b>
					<?php $date=date_create($view_expenditure['expenditure_date']);?>
            ...
            <div class="invoice-table mt-3 text-left">
                ...
                <table class="table table-responsive-lg">
                    <?php 
                	    $igst=explode("<br>",$view_expenditure['igst']);
                    $discount = explode("<br>",$view_expenditure['pro_discount']); ?>
					...
					$totalsGst=0;
					$totalcGst=0;
					if($view_expenditure['product_name']!=""){
						$product_name=explode("<br>",$view_expenditure['product_name']);
						if(!empty($view_expenditure['gst'])){
						$gst=explode("<br>",$view_expenditure['gst']);
						}
						$quantity=explode("<br>",$view_expenditure['quantity']);
						$unit_price=explode("<br>",$view_expenditure['unit_price']);
						$hsnsac = explode("<br>",$view_expenditure['hsn_sac']);
						$total=explode("<br>",$view_expenditure['total']);
						$descriptionPro=explode("<br>",$view_expenditure['pro_description']);
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-6">
                        <div class="bank-total-left">
                            <p>Total In Words: <b>
							<?php  $get_amount= AmountInWords($view_expenditure['sub_total']);
							echo $get_amount;
							?></b></p>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                        <div class="bank-total-right">
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_expenditure['initial_total']);?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col text-right">
                                    (₹ <?=IND_money_format($view_expenditure['total_discount']);?>)
                                </div>
                            </div>
                           
							<?php //if($igst[0]!=""){ ?>
							<?php if($view_expenditure['type']=="Interstate"){ ?>
							<div class="row">
                                <div class="col">
                                    IGST
                                </div>
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_expenditure['total_igst']); ?>
                                </div>
                            </div>
							<?php }else if($view_expenditure['type']=="Instate"){?>
                            <div class="row">
                                <div class="col">
                                    SGST
                                </div>
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_expenditure['total_sgst']);?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_expenditure['total_cgst']);?>
                                </div>
                            </div>
							<?php } ?>
							<?php  if($view_expenditure['extra_charge_value']!=""){ 
							$extraCharge_name=explode("<br>",$view_expenditure['extra_charge_label']);
							$extraCharge_value=explode("<br>",$view_expenditure['extra_charge_value']);
                            ...
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    ₹ <?=IND_money_format($view_expenditure['sub_total']);?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="terms-condition">
                ...
                <ol>
				<?php if($view_expenditure['terms_condition']!=""){
					$terms_condition=explode("<br>",$view_expenditure['terms_condition']);
			...
			<div class="terms-condition">
				<div class="row">
					...
					<div class="col">
						<div class="details-switch">
							<label class="switch">
								<input type="checkbox" id="slider_declaration" onchange="enable_declaration('<?=$view_expenditure['id'];?>')" name="slider_declaration" <?php if($view_expenditure['declaration_status']==1){ echo "checked"; } ?> >
				...
				<div class="row">
					<?php if($view_expenditure['invoice_declaration']!=""){ echo $view_expenditure['invoice_declaration']; } ?>
				</div>
			...
			<div class="terms-condition">
                <p><b>Note :-</b> </p>
				<?php if($view_expenditure['notes']!=""){ echo $view_expenditure['notes']; } ?>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                         <ul class="list-group list-group-horizontal">
							...
							<?php if($this->session->userdata('update_pi')=='1'): ?>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>add-expanse/<?=$view_expenditure['po_id']?>"><div><img src="https://img.icons8.com/cotton/18/000000/edit--v1.png"></div>Edit Expemditure</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="right-buttons d-flex justify-content-end">
                        <ul class="list-group list-group-horizontal">
						    <li class="list-group-item text-center"><a href="<?=base_url();?>Accounting/generate-pdf-deliverychallan?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>" target="_blank"><div><img src="https://img.icons8.com/color/18/000000/print.png"/></div>Print</a>
                            </li>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>Accounting/generate-pdf-deliverychallan?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>&dn=1" target="_blank"><div><img src="https://img.icons8.com/fluent/20/000000/download.png"/></div>Download</a>
                            </li>
                            <li class="list-group-item text-center" onclick="update_billedby(15)" style="cursor:pointer;" ><a><div><img src="https://img.icons8.com/office/18/000000/share.png"/></div>Share</a>
                            </li>
                            <li class="list-group-item text-center" onClick="shareEmail();"><a href="#" ><div><img src="https://img.icons8.com/ultraviolet/18/000000/email-open--v1.png"/></div>Email Expenditure</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
       ...
       <input type="hidden" class="form-control" value="<?=$view_expenditure['id'];?>" id="piid">
	   <input type="hidden" class="form-control" value="<?=$view_expenditure['session_comp_email'];?>" id="compeml">
		<input type="hidden" class="form-control" value="<?=$view_expenditure['session_company'];?>" id="compname">
      <div class="modal-body" style="padding: 5%;">
          <div class="row" id="formDiv">
			...
			<div class="col-md-10">
			  <input type="text" class="form-control" value="Invoices For <?=$clientDtl->org_name;?> - #<?=$view_expenditure['creditnote_no'];?>" name="subEmail" id="subEmail">
            </div>
			...
			<div class="col-md-12">
			  <textarea class="form-control" id="descriptionTxt"   name="descriptionTxt">
				...
				<p>Please find attached invoice #<?=$view_expenditure['creditnote_no'];?>.</p>
				<p>Invoice No: #<?=$view_expenditure['creditnote_no'];?></p>
				<p>Billed To: <?=$clientDtl->org_name;?></p>
				<p>Total Amount: ₹ <?=IND_money_format($view_expenditure['sub_total']);?></p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form">
                  <form action="#" id="payment_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                    <input type="hidden"  name="sales_id" id="sales_id" value="<?php echo $view_expenditure['saleorder_id'];?>" >
					<input type="hidden"   name="inv_id" id="inv_id" value="<?php echo $view_expenditure['id'];?>" >
