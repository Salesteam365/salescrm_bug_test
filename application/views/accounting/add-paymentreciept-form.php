    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6 offset-sm-1">
          <h1 class="m-0 text-dark text-right" style="-webkit-text-fill-color: unset;"><?php if(isset($action['data']) && $action['data']=='update'){ echo 'Update'; }else{ echo "Add";  }  ?> Payment Reciept</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-5">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
             ...
             <li class="breadcrumb-item">
                 <a href="<?php echo base_url()."payment-reciept "; ?>">Payment Reciept</a>
            </li>
            <li class="breadcrumb-item active">Add Payment Reciept</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
	   ...
	   if(isset($action['data']) && $action['data']=='update'){ 
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				 <div class="form-group">
					...
					<input type="text" class="form-control" name="paymentreceipt_no" placeholder="Payment Receipt No" id="paymentreceipt_no" value="<?php echo $creditnotenum;?>">
					<span id="invoice_no_error"></span>
				 </div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
