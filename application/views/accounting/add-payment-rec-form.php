                ...
                <div class="accordion mx-4" id="faq" >
                    ...
                    <div class="quoteaccordion">
                            ...
                            <div id="faq2" class="collapse" aria-labelledby="faqhead2" data-parent="#faq">
                                <div class="row p-4">
                                    <div class="container">
                                        <div class="row justify-content-center text-center">
                                            <div class="table-responsive" style="border:1px solid rgba(230,230,230,0.8); padding:5px; padding-bottom:0px;">  
                                                <table id="paymentListing" class="table table-striped">
                                                    ...
                                                    <thead class ="thead-light ">
                                                        <tr id="recortotals">
                                                           <td colspan="8"> No record Added</td>
                                                        </tr>
                                ...
                                <div class ="row"style = "padding-left: 10px;">
                                    <div class="quoteacc_head mx-2 my-2" id="faqhead3" data-toggle="collapse" data-target="#faq3" aria-expanded="false" aria-controls="faq1"> <a href="#" class="btn btn-primary " > Continue</a>
                                    </div>
                                </div>
                    ...
                    <div class="quoteaccordion selectedDiv" id ="div1payment" style="display:none;">
                        ...
                        <div id="faq3" class="collapse" aria-labelledby="faqhead3" data-parent="#faq">
                            ...
                            <div id="invoicesContainer" style="border:1px solid rgba(230,230,230,0.8); padding:5px; padding-bottom:0px;">
                                <table id="invoicesTable" class="table table-striped" style="table-layout:fixed;">
                                    <thead class="thead-light">
                                        <tr>
                                            <th>Invoice No.</th>
                                            <th> Due Date</th>
                                ...
                                <table id="" class="table table-striped" style="table-layout:fixed;">
                                        <thead class ="thead-light">
                                            <tr>
                                                <th id = "total_i"></th>
                                                <th id = "totalempity_i"></th>
                          ...
                          <br>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-4 text-center"> 
                                    <div class="card mb-3" id="payreciept_option_card" style="border:2px solid black; border-radius: 10px;"> <!-- Added border-radius -->
...
document.getElementById('LinkEmployeeAccountButton').addEventListener('click', function() { 
    ...
    // Define the Unpaid_invoices function
function Unpaid_invoices() {
    ...
    $.ajax({
        ...
        type: 'POST',
        dataType: 'json',
        data: { id: $('#invoice_no_select').val() }, // Using direct reference instead of $(this)
        success: function(response) {
            if (response.status === 'success') {
                ...
                $('#invoicesTable tbody').html('<tr><td colspan="9">No invoices Selected </td></tr>');
            }
        },
        error: function() {
            // If AJAX call fails
            $('#invoicesTable tbody').html('<tr><td colspan="9">Failed to retrieve data. Please try again.</td></tr>');
        }
    });
}
    ...
    Unpaid_invoices();
        ...
        // Bind Unpaid_invoices function to the change event of invoice number select
    ...
    function save() {
        ...
        function updateTotals() {
            ...
            var updatetotalrow=`<td>Total</td>
                                <td></td>
                                <td id="totalAmountReceived">${totalAmountReceived.toFixed(2)}</td>
                                <td></td>
                                <td id="totalTransactionCharge">${totalTransactionCharge.toFixed(2)}</td>
                                <td id="totalTds"> ${totalTds.toFixed(2)}</td>
                                <td></td>
                                <td></td>`;
                                $("#recortotals").html(updatetotalrow);
        }
...
//< ----------------- option payment receipt and Client advance ---------------------->
    ...
    selectDiv('div1payment');
    $(".card").click(function(){
        $("#payreciept_option_card").css('border','none');    
    })
