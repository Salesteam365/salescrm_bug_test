    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6 offset-sm-1">
          <h1 class="m-0 text-dark text-right" style="-webkit-text-fill-color: unset;"><?php if(isset($action['data']) && $action['data']=='update'){ echo 'Update'; }else{ echo "Add";  }  ?> Credit Note</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-5">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
             ...
             <li class="breadcrumb-item">
                 <a href="<?php echo base_url()."credit-note"; ?>">Credit Note</a>
            </li>
    ...
    <div class="container">
	  <div class="invoice-section">
	   <div class="row">
			...
			<input type="hidden"  name="invc_id"  id="invc_id" value="<?php if(!empty($this->uri->segment(2))){ echo $this->uri->segment(2); }?>">
			<input type="hidden" name="save_method" id="save_method" value="<?php if(isset($action['data']) && $action['data']=='update'){ echo $action['data']; }else{ echo "add";  }  ?>" >
	   ...
	   if(isset($action['data']) && $action['data']=='update'){ 
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				 <div class="form-group">
					<label for="">Credit Note no.<span style="color: #f76c6c;">*</span>:</label>
					<input type="text" class="form-control" name="creditnote_no" placeholder="Credit Note No." id="creditnote_no" value="<?php echo $creditnotenum;?>">
					<span id="invoice_no_error"></span>
				 </div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="form-group">
					<label for="">Credit Note Date<span style="color: #f76c6c;">*</span>:</label>
					<input type="date" class="form-control" name="creditnote_date" placeholder="" id="creditnote_date" value="<?php echo date('Y-m-d');?>">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				...
				<div class="form-group">
					...
					<select class="form-control" name="terms_select" id="terms_select">
					  ...
					  <option value="Fault/Defect in service">Fault/Defect in service</option>
				...
				?>
                  <tr class="removCL<?=$rw;?>">
					...
					<input type="text" name="product_name[]"  class="form-control productItm checkvl" id="proName<?=$rw;?>" data-cntid="<?=$rw;?>" onkeyup="getproductinfo();"  placeholder="Items name(required)" value="<?=$proName[$pr];?>"><span id="items_error"></span></td>
                     ...
                     <td><input type="text" name="hsn_sac[]" class="form-control" id="hsn<?=$rw;?>" placeholder="HSN/SAC" value="<?php if(isset($hsn_sac[$pr])){ echo $hsn_sac[$pr]; } ?>" readonly></td>
            ...
            <div class="row">
        		...
        		<!---Discount Field--->	
                 ...
                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 text-right">
                    <p class="discount">
                        <input type="hidden" id="discounts" name="discount" onkeyup="calculate_pro_price()" value="<?php if(isset($record['discount']) && $record['discount']!=""){ echo $record['discount'];  }?>" class="form-control">
                    </p>
                 </div>
        	    ...
        	    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                    <p class="sub_amount">Amount after credit note :</p>
                </div>
        	 ...
        	 <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                <p class="sgst">SGST after credit note :</p>
                <p class="cgst">CGST after credit note :</p>
        		<p class="igst">IGST after credit note :</p>
             </div>	
            ...
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="total-price">
                  <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 inrRp">
                      <h4>Total (INR) after credit note</h4>
                    </div>
                    <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-12 inrIcn">
...
<script>
	...
	if(checkValidationWithClass('form_invoice')==1){
			...
			// alert(save_method);
			if(save_method == 'add') {
				url = "<?= site_url('Accounting/add_creditnoteDetails')?>";
				if(url){
					toastr.info('Data Inserted successfully');
				}else{
					toastr.info('Data Inserted Failed');
				}

			} else {
				url = "<?= site_url('Accounting/update_creditnoteDetails')?>";
				if(url){
					toastr.info('Data Updateed successfully');
				}else{
					toastr.info('Data Updateed Failed');
				}
			}
			...
			$.ajax({
				...
				{ 
				  ...
				  window.location.href = '<?php echo base_url("credit-note"); ?>';
				},
