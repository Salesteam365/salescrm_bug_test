    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6 offset-sm-1">
          <h1 class="m-0 text-dark text-right" style="-webkit-text-fill-color: unset;"><?php if(isset($action['data']) && $action['data']=='update'){ echo "Update"; }else{ echo "Add"; } ?> Debit Note</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-5">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
             ...
             <li class="breadcrumb-item">
                 <a href="<?php echo base_url()."debit-note "; ?>">Debit Note</a>
            </li>
            <li class="breadcrumb-item active"><?php if(isset($action['data']) && $action['data']=='update'){ echo "Update"; }else{ echo "Add"; } ?> Debit Note</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
    ...
    <div class="container">
	  <div class="invoice-section">
	   ...
	   if(isset($action['data']) && $action['data']=='update'){ 
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				 <div class="form-group">
					<label for="">Debit Note No.<span style="color: #f76c6c;">*</span>:</label>
					<input type="text" class="form-control" name="creditnote_no" placeholder="Debit Note No" id="creditnote_no" value="<?php echo $debitnotenum;?>">
					<span id="invoice_no_error"></span>
				 </div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="form-group">
					<label for="">Debit Note Date<span style="color: #f76c6c;">*</span>:</label>
					<input type="date" class="form-control" name="creditnote_date" placeholder="Debit Note Date (MM/DD/YYYY)" id="creditnote_date" value="<?php echo date('Y-m-d');?>" >
					<span id="invoice_date_error"></span>
				</div>
			</div>
...
function save(){
	if(checkValidationWithClass('form_invoice')==1){
			...
			if(save_method == 'add') {
				url = "<?= site_url('Accounting/add_debitnoteDetails')?>";
				if(url){
				...
				url = "<?= site_url('Accounting/update_debitnoteDetails')?>";
				if(url){
			...
			$.ajax({
				...
				{ 
				  ...
				  window.location.href = '<?php echo base_url("debit-note"); ?>';
				},
