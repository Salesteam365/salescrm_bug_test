      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add  New Expanse </h5>
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="exampleInput">Linked Po No.</label>
              <input type="text" class="form-control" name="ponum" id="linkedinvoicenum" placeholder="Enter linked Po number">
  ...
  <div class="content-wrapper" style="background-color:rgba(240,240,246,0.3);overflow-x:clip;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Expanse Management</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('home'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Expanse Management</li>
            </ol>
          </div><!-- /.col -->
        </div>
        <!-- /.row -->
          ...
          <div class="col-lg-2">
                  ...
                  <div class="col-lg-1"></div>
                    ...
                    <button class="btnstopcorner" onclick="refreshPage()"><i class="fas fa-redo-alt"></i></button>
                      <?php if($this->session->userdata('type')=='admin'){ ?>
                      <a href='Export_data/export_expenditure' class="p-0" ><button class="btncorner">Export Data</button></a>
                      <?php } ?>
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <!-- <div class="dropdown-item"><a style="color:black; padding-left:0px;" href="<?php echo base_url('add-expanse');?>">Add New Expanditure</a></div> -->
                        <div class="dropdown-item" id="addnewexpanse"><a style="color:black; padding-left:0px;" href="javascript:void(0);">Add New Expanditure</a></div>
    ...
    <!-- filter box ends -->
         <div class="accordion mx-3" id="faq" >
            <div class="quoteaccordion">
               <div class="quoteacc_head" id="faqhead1" data-toggle="collapse" data-target="#faq1" aria-expanded="false" aria-controls="faq1"> <a href="#" class="btn btn-header-link" ><i class="fas fa-file-alt"></i> Expanse Summary</a>
               </div>
            ...
            <div class="quoteaccordion">
               <div class="quoteacc_head" id="faqhead2" data-toggle="collapse" data-target="#faq2" aria-expanded="false" aria-controls="faq2"> <a href="#" class="btn btn-header-link" ><i class="fas fa-file-alt"></i> Expanse Graph</a>
               </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                              <?php if($this->session->userdata('type')=='admin'){?>
                                ...
                                <?php } ?>
                                <tr>
                                  <td> Expanditure Date</td>
                                  <td align="center"><input class="inputbox" type="checkbox" checked ></td>
                                </tr>
                                <tr>
                                <td>Expanditure No.</td>
                                  <td align="center"><input class="inputbox" type="checkbox" checked  ></td>
                                </tr>
                                <tr>
                                <td>Po Date</td>
...
<div class="wrapper card p-4" style="border-radius:12px;border:none;box-shadow:0px;">
            <div class="card-header mb-2"><b style="font-size:21px;">Expanse Management</b>
             <button type="button" id="btnshowhide" class="btn btn-outline-secondary" data-toggle="modal" data-target="#exampleModal" style="">
                   <i class="fa fa-table" aria-hidden="true" style="color:purple;"></i>&nbsp;
           ...
           <!-- model end -->
                    <thead>
                      <tr>
                        ...
                        <th class="th-sm" style="width:20%;" >Expenditure No.</th>
                        <th class="th-sm" style="width: 275px;">PO Date </th>
...
//     });
    ...
    $("#saveChangesBtn").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('Accounting/add_expanse');?>",
            data: formData,
            dataType: 'json', 
            success: function(response) {
                if (response.success) {
                  var invoiceId = response.invoice_id;
                    var redirectUrl = "<?php echo base_url('add-expanse/');?>" + invoiceId;
                    ...
                    swal({
                        icon: 'error',
                        title: 'Po Number Not Found',
                        text: 'Please enter a valid po number.'
                    });
        ...
        "ajax": {
            ...
            "data": function (data) {
                ...
                "dataSrc": function(json) {
                    $('#totalRecords').text("Total Expanses : " + json.recordsTotal );
                    $('#totalAmounts').text("Amount : ₹ " + json.sum_data.total_amount); 
                    $('#dueAmount').text("Due Amount : ₹ " + json.sum_data.pending_payment); 
                    return json.data; 
                }
...
function delete_expanse(id)
  {
      if(confirm('Are you sure delete this data?'))
      {
          // ajax delete data to database
          $.ajax({
              url : "<?= site_url('Accounting/expanse_delete')?>/"+id,
              type: "POST",
              dataType: "JSON",
              success: function(data)
              {
               
                $("#common_popupmsg").html('<i class="far fa-check-circle" style="color: #60b963;"></i><br>Expenditure Management information has been deleted.');				
      ...
      ////////////////////////////////////// fetch the data of month wise expanse amount for quotation graph/////////////////////////////////////



    $.ajax({
        url:'<?php echo site_url('Accounting/get_expanse_graph')?>',
        method:'post',
        success:function(response){
      ...
      var options = {
          series: [
              { name: 'Expanse Amount of month', data: expanse_amount },
          ],
          chart: {
              height: 250,
              type: 'area'
