  ...
  background-color: #f0f0f0; /* Change background color on hover */
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add new Credit Note</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="creditNoteForm" method="post" action="<?php echo base_url('add-creditnote'); ?>">
                    <div class="form-group">
                        <label for="exampleInput">Linked Invoice no.</label>
                        <input type="text" class="form-control" name="invoicenum" id="linkedinvoicenum" placeholder="Enter linked invoice number">
                    </div>
                </form>
            </div>
    ...
    <div class="content-wrapper" style="background-color:rgba(240,240,246,0.3);overflow-x:clip;">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Credit Note</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="container-fliud filterbtncon"  >
            ...
            <div class="row mb-3">
                    ...
                    <div class="col-lg-1"></div>
                        ...
                        <?php if($this->session->userdata('type')=='admin'){ ?>
                        <a href='Export_data/export_creditnote' class="p-0" ><button class="btncorner">Export Data</button></a>
                        <?php } ?>
                        ...
                        <?php }else{ ?>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                              <div class="dropdown-item" id="addnewcreditnote"><a style="color:black; padding-left:0px;" href="javascript:void(0);">Add New Credit Note</a></div>
                              <!-- <div class="dropdown-item"><a style="color:black; padding-left:0px;" href="<?php echo base_url('invoices/performa-invoice'); ?>">Create New Performa Invoice</a></div> -->
    ...
    <div class="card mx-md-5 mt-2 mb-0 px-5 py-4" style="border-radius:12px;">
      <div class="filterbox">
          ...
          <div class="card-body">
              <!-- <h4 style="margin-bottom:18px;">Credit Note Filter</h4> -->
            <div class="row">
                <div class="col-lg-4">
                    <!-- <h5>Select Date</h5> -->
                    <div class="first-one">
                ...
                <div class="col-lg-4">
                  <!-- <h5>Select User</h5> -->
                  <div class="first-one">
                      <!-- <select class="custom-select filterby" name="user_filter"  id="user_filter">
                        <option selected value="">Select User</option>
                        <?php foreach($admin as $adminDtl){ ?>
    ...
    <!-- filter box ends -->
         <div class="accordion mx-3" id="faq" >
            <div class="quoteaccordion">
               <div class="quoteacc_head" id="faqhead1" data-toggle="collapse" data-target="#faq1" aria-expanded="false" aria-controls="faq1"> <a href="#" class="btn btn-header-link" ><i class="fas fa-file-alt"></i> Credit Note Summary</a> </div>
              ...
              <div class="quoteaccordion">
               <div class="quoteacc_head" id="faqhead2" data-toggle="collapse" data-target="#faq2" aria-expanded="false" aria-controls="faq2"> <a href="#" class="btn btn-header-link" ><i class="fas fa-file-alt"></i> Credit Note Graph</a>
               </div>
...
<div class="wrapper card p-4" style="border-radius:12px;border:none;box-shadow:0px;">
            <div class="card-header mb-2"><b style="font-size:21px;">Credit Note</b> <button type="button" id="btnshowhide" class="btn btn-outline-secondary" data-toggle="modal" data-target="#exampleModal" style="">
                   <i class="fa fa-table" aria-hidden="true" style="color:purple;"></i>&nbsp;
                    ...
                    <thead>
                      <tr>
                        <?php if(check_permission_status('Quotations','delete_u')==true):?>
                          ...
                          <!-- <th class ="th-sm"> <input type="checkbox" class="checkSingle" id="checkAll" value="allmail"></th> -->
                        <?php endif; ?>
                       
                        <th class="th-sm" style="" >Credit Date</th>
                        <th class="th-sm" style="">Credit No.</th>
                        <th class="th-sm" style="">Credit Amount</th>
                        <th class="th-sm" style="">Invoice No.</th>
                        <th class="th-sm" style="">Invoice Amount</th>
                        <th class="th-sm">Issued To</th>
                        <th class="th-sm">Invoice Date</th>
                        <!-- <th class="th-sm">Status</th> -->
                        <!-- <th class="th-sm">GSTIN/UIN of Recipient</th> -->
                        <!-- <th class="th-sm">PAN</th> -->
                        <!-- <th class="th-sm">Credit Consumed</th> -->
...
<script>
  ...
  $(document).ready(function(){
        // Trigger date picker when the input box is clicked
...
function delete_creditnote(id)
  {
      if(confirm('Are you sure delete this data?'))
      {
          ...
          $.ajax({
              url : "<?= site_url('Accounting/creditnote_delete')?>/"+id,
              type: "POST",
              dataType: "JSON",
              success: function(data)
              {
               
                $("#common_popupmsg").html('<i class="far fa-check-circle" style="color: #60b963;"></i><br>Creditnote information has been deleted.');				
  ...
  $(".filterby").each(function(){
    $(this).change(function(){
      var filtername = $(this).attr('name');
       ...
       $.ajax({
        url:'<?php echo site_url('Accounting/getcreditnotedata');?>',
        method:'post',
        data:formdata,
...
$("#saveChangesBtn").click(function() {
    ...
    var formData = $("#creditNoteForm").serialize();
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('Accounting/add_creditnote');?>",
        data: formData,
        dataType: 'json', 
        success: function(response) {
            if (response.success) {
              var invoiceId = response.invoice_id;
                var redirectUrl = "<?php echo base_url('add-creditnote/');?>" + invoiceId;
                ...
                swal({
                    ...
                    text: 'Please enter a valid invoice number.'
                });
  ...
  table = $('#ajax_datatable').DataTable({
      ...
      "ajax": {
          ...
          "dataSrc": function(json) {
           ...
           $('#totalRecords').text("Credit Notes : " + json.recordsTotal_cc);
            $('#totalAmounts').text("Credit Amount : ₹ " + json.recordsFiltered_cc); 
            return json.data; 
         }
...
<script>
  $("#addnewcreditnote").click(function(){
    ...
    $.ajax({
        url:'<?php echo site_url('Accounting/get_creditnote_graph')?>',
        method:'post',
        success:function(response){
        ...
        for (var i = 0; i < response.data.length; i++) {
          credit_amount.push(parseFloat(response.data[i].subtotal)); 
      ...
      var options = {
          series: [
              { name: 'Credit Note Amount of month', data: credit_amount },
          ],
          chart: {
              height: 250,
              type: 'area'
