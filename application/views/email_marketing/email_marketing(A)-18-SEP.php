                ...
                <div class="row form-group" >
                   <div class="col-sm-3">
                    ...
                    <div class="refresh_button float-right">   
                        <a href='<?= base_url() ?>Email_Marketing/email_export_csv' class="p-0" ><button class="btn btn-info" >Export</button></a>
                        <button class="btn btn-info" id="SendEmailBulk">Send Email In Bulk</button>
                        <button class="btn btn-info" id="SendEmailWithCSV">Send Email From CSV File</button>
						<button class="btn btn-info" id="SendEmailWithTemplate">Email using template</button>
