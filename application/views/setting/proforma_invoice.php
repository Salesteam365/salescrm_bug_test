...
<div class="content-wrapper" style="background-color:rgba(240,240,246,0.8);">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark text-right" style="-webkit-text-fill-color: unset;">Proforma Invoice</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">
             ...
             <li class="breadcrumb-item">
                 <a href="<?php echo base_url()."proforma_invoice "; ?>">Proforma Invoice</a>
            </li>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
		  ...
		  <input type="hidden"  name="invc_id"  id="invc_id" value="<?php if(!empty($this->uri->segment(3))){ echo $this->uri->segment(3); }?>">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="invoice_no" placeholder="Enter Invoice No." id="invoice_no" value="<?php if(isset($record['invoice_no'])){ echo $record['invoice_no']; }  ?>" <?php if(isset($record['invoice_no'])){ echo "readonly";   }else{ echo 'onblur="check_invoiceNo()"'; } ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
          <div class="billedby">
		  <?php if((isset($_GET['pg']) && $_GET['pg']=='purchaseorder') || (isset($record['page_name']) && $record['page_name']=='purchaseorder')){ ?>
		  <h3>Ship To:-<span> (Your Details) </span></h3>
		  <?php }else{ ?>
            <h3>Billed By<span style="color: #f76c6c;">*</span><span> (Your Details) </span></h3>
          <?php } ?>  
          
              <div class="form-group">
			    <select class="form-control" name="billedby" id="billed_by">
            ...
            <div class="business_detail">
              <div class="container p-0">
                <div class="row">
				  ...
				  <?php if((isset($_GET['pg']) && $_GET['pg']=='purchaseorder') || (isset($record['page_name']) && $record['page_name']=='purchaseorder')){ ?>
				  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-right" id=""></div>
				  <?php }else{ ?>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-right" id="show_editlink"></div> 
				  <?php } ?>
              ...
              <p><b>PAN:</b> <span id="pan_no"></span></p>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
		  ...
		  <?php if((isset($_GET['pg']) && $_GET['pg']=='purchaseorder') || (isset($record['page_name']) && $record['page_name']=='purchaseorder')){ ?>
		  <h3>Supplier Name:-<span> (Vendor Details) </span></h3>
		  <?php }else{ ?>
            <h3>Billed To<span style="color: #f76c6c;">*</span><span> (Client Details) </span></h3>
          <?php } ?>
            
            
              <div class="form-group">
				<select class="form-control" name="billedto" id="billedto_select" onchange="showBillto(this.options[this.selectedIndex].value)">
				   <option value="">Select Organization</option>
				   <?php foreach($org_details as $org){ ?>
				    <option value="<?=$org->org_name; ?>" <?php if(isset($record['billedto_orgname']) && $record['billedto_orgname']==$org->org_name){ echo "selected"; }else if((isset($record['org_name']) && ($org->org_name==$record['org_name'])) || isset($record['supplier_comp_name']) && $record['supplier_comp_name']!="" ){ echo "selected"; } ;?>   ><?=$org->org_name; ?></option>
				   <?php } ?>
                </select>
              </div>
			  <div class="business_detail" id="show_bdetails">
			   <div class="container p-0">
					<div class="row">
					  ...
					  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-right" id=""></div>
					  <?php }else{ ?>
					  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-right" id="show_editlinkto"></div> 
					  <?php } ?>
					</div>
               </div>
				<p><b>Business Name:</b> <span id="bname_to"></span></p>
				<p> <b>Address:</b> 
					<span id="adress_to"></span>, 
					<span id="city_to"></span>, 
					<span id="state_to"></span> - 
					<span id="zipcode_to"></span>, 
					<span id="country_to"></span>
				</p>
				<p><b>Email: </b><span id="email_to"></span></p>
				<p><b>Phone:</b> <span id="phone_to"></span></p>
            ...
            <div class="business_detail text-center" id="show_addBdetails">
			  ...
			  <i class="far fa-user-circle"></i>
                ...
                <p>Or</p>
                <button type="button" onclick="add_org()"><i class="fa fa-plus"></i> Add New Client</button>
              </div>
            </div>
              ...
              <table class="table table-responsive-lg" width="100%" id="add_new_line" >
               ...
               <?php 
				...
				?>
                  <tr class="removCL<?=$rw;?>">
                    <td>
					<input type="text" name="items[]" id="items" placeholder="Items name(required)" value="<?=$proName[$pr];?>"><span id="items_error"></span></td>
					
                    <td><input type="text" name="hash[]" placeholder="HSN/SAC" value="<?=$hsn_sac[$pr];?>"></td>
					
                    <td class="gst">
					<input type="text" name="gst[]"  onkeyup="calculate_invoice()" placeholder="GST in %" value="<?=$gst[$pr];?>" list="taxName">
					        <?php echo $dataList; ?></td>
					
                    <td ><input type="text"  onkeyup="calculate_invoice()" name="quantity[]" id="qty"  placeholder="qty" value="<?=$quantity[$pr];?>"><span id="quantity_error"></span></td>
					
                    <td><input type="text" class="start" onkeyup="calculate_invoice()" name="unit_price[]"  id="unit_price" placeholder="rate" value="<?=$unit_price[$pr];?>"><span id="unit_price_error"></span></td>   
                  ...
                  <tr class=" <?php if(empty($proDescription[$pr])){ ?> pro_descrption <?php } ?>  removCL<?=$rw;?> addCL<?=$rw;?>" <?php if(empty($proDescription[$pr])){ ?> style="display:none;" <?php } ?> >
                    <td colspan="11">
                      <input type="text" name="product_desc[]" value="<?php if(isset($proDescription[$pr])){ echo $proDescription[$pr]; }?>"  placeholder="Description">
                    </td>
                  </tr>
                  <tr class="removCL<?=$rw;?>">
                    <td class="delete_new_line" colspan="2" onClick="removeRow('removCL<?=$rw;?>');">
				...
				<tr class="removCL0">
                    <td>
					<input type="text" name="items[]" id="items" placeholder="Items name(required)" value=""><span id="items_error"></span></td>
					
                    <td><input type="text" name="hash[]" placeholder="HSN/SAC" value=""></td>
					
                    <td class="gst">
					<input type="text" name="gst[]"  onkeyup="calculate_invoice()" placeholder="GST in %" value="" list="taxName">
					        <?php echo $dataList; ?> </td>
					
                    <td ><input type="text"  onkeyup="calculate_invoice()" name="quantity[]" id="qty"  placeholder="qty" value=""><span id="quantity_error"></span></td>
					
                    <td><input type="text" class="start" onkeyup="calculate_invoice()" name="unit_price[]"  id="unit_price" placeholder="rate" value=""><span id="unit_price_error"></span></td>   
					
                    <td><input type="text" name="total[]" class="" readonly value=""></td>
					
                    <td class="cgst"><input type="text" name="cgst[]" value="" class="" readonly></td>
					
                    <td class="sgst"><input type="text" name="sgst[]" value="" class="" readonly></td>
					
                    <td class="igst"><input type="text" name="igst[]" value="" class="" readonly></td>
					
					<td class="sub_total"><input type="text" name="sub_total[]" class="" readonly></td>
                  </tr>
                  <tr class="pro_descrption removCL0 addCL0"  style="display:none;" >
                    <td colspan="11">
                      <input type="text" name="product_desc[]" value=""  placeholder="Description">
                    </td>
                  </tr>
                  <tr class="removCL0">
  ...
  <div class="attachment" style="background: #ffffff;">
    <div class="container" style="background: #f8faff; padding: 15px;">
      ...
      <div class="modal-body">
        <form class="business_detail_form" action="" id="business_mod">
          ...
          <div class="row">
            ...
            <button class="btn" type="button" id="branchSave" onclick="save_branch()">Update</button>
          </div>
        </form>
      </div>
...
<div class="modal fade" id="organiazation_detail">
  ...
  <!-- Add new modal -->
<div class="modal fade show" id="modal_form" role="dialog" aria-modal="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="organization_add_edit">Add Organization</h3>
                  ...
                  <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body form-row">
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control onlyLetters" name="org_name" id="org_name_check" placeholder="Organization Name" onChange="check_org()" required>
...
<script>
  ...
  <script>
   //jQuery('#div'+$(".show_div").attr('target')).hide();
...
calculate_invoice();
    ...
    {
	  i++;
     var markup = '<tr class="removCL'+i+'" ><td><input type="text" name="items[]" id="items" placeholder="Items name(required)"><span id="items_error"></span></td>'+
      '<td><input type="text" name="hash[]" placeholder="HSN/SAC"></td>'+
      '<td class="gst"><input type="text" name="gst[]" onkeyup="calculate_invoice()" value="" placeholder="GST in %"  list="taxName" ></td>'+
      '<td ><input type="text" onkeyup="calculate_invoice()" id="qty" class="integer_validqty'+i+'" name="quantity[]" placeholder="qty"><span id="quantity_error"></span></td>'+
      '<td><input type="text" name="unit_price[]" id="unit_price" class="start float_validup'+i+'" onkeyup="calculate_invoice()" placeholder="rate"><span id="unit_price_error"></td>'+ 
	  '<td><input type="text" name="total[]" class="" readonly></td>'+
       '<td class="cgst"><input type="text" name="cgst[]" class="" readonly></td>'+
      ' <td class="sgst"><input type="text" name="sgst[]" class="" readonly></td>'+
       '<td class="igst"><input type="text" name="igst[]" class="" readonly></td>'+
		...
		'<tr class="pro_descrption removCL'+i+' addCL'+i+'"><td colspan="10">'+
           '<input type="text" name="product_desc[]" id="" placeholder="Description"></td></tr>'+
...
<script>
	...
	var url = "<?php echo site_url('home/getbranchbyId')?>/"+id;
	//alert(id);
		$.ajax({
            url : url,
            type: "GET",
    ...
    $.ajax({
        url : "<?= site_url('proforma_invoice/update_branch')?>",
        type: "POST",
...
if(invcId=="" && invcId!==undefined){
	urlInvce="<?= base_url('Proforma_invoice/add_invoiceDetails')?>";
}else{
	urlInvce="<?= base_url('Proforma_invoice/update_invoiceDetails')?>";
}
        ...
        $.ajax({
            ...
            { 
              ...
              if(data.status) //if success close modal and reload ajax table
              {
                ...
                if(invcId=="" && invcId!==undefined){
                    $("#common_popupmsg").html('<i class="far fa-check-circle" style="color: #60b963;"></i><br>Proforma invoice has been inserted.');
						
				}else{
					$("#common_popupmsg").html('<i class="far fa-check-circle" style="color: #60b963;"></i><br>Proforma invoice has been updated.');
				}
                 
				$('#invoiceSave').text('Save & Continue'); 
                $('#invoiceSave').attr('disabled',false);
                $("#alert_popup").modal('show');
				setTimeout(function(){ $("#alert_popup").modal('hide'); 	window.location.href = "<?= base_url('Proforma_invoice')?>"; },2000);
	...
	function checkValidation_invoice(){
	  ...
	  var billedto_select=$('#billedto_select').val();
		...
		if(invoice_no=="" || invoice_no===undefined ){
		  ...
		  changeClr('billed_by');
		  $('#billedby_error').html('<span style="color:red;">BusinessBy is required</span>');
		  $('#ErrorMsg').append('<li>BusinessBy is required</li>'); 
		  $('#errorMsgbox').show();
		  return false;
		}else if(billedto_select=="" || billedto_select===undefined){
		  changeClr('show_addBdetails');
		  $('#billedto_error').html('<span style="color:red;">BusinessTo is required</span>');
		  $('#ErrorMsg').append('<li>BusinessTo is required</li>'); 
		  $('#errorMsgbox').show();
		  return false;
		}else{
			var num=0;
	...
	$('#billedto_select').change(function(){	 
	   $('#billedto_error').html('');
	   $('#ErrorMsg').html('');
	   $('#errorMsgbox').hide();
	});
...
<script type="text/javascript">
$(document).ready(function(){
  $('#org_names').autocomplete({
    source: "<?= site_url('organizations/autocomplete_org');?>",
...
<script>
		...
		$.ajax({
          ...
          success: function(response){
            ...
            if(len > 0)
            {
			  ...
			  $('#gstnoCustomer').val(response[0].gstin);
	...
	function gstSelect(){
		...
		var custStateGstNo= customergst.substring(0, 2);
		var yourStateNo	  = branchgst.substring(0, 2);
		if(custStateGstNo==yourStateNo && yourStateNo!=""){
  ...
  function add_org()
  {
      ...
      $('#organization_add_edit').text('Add Organization'); // Set Title to Bootstrap modal title
      $("#add").find("tr").remove();
 ...
 function update_org(id)
  {
    ...
    //Ajax Load data from ajax
    $.ajax({
      url : "<?php echo site_url('organizations/getbyId/')?>/" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data)
      {
        ...
        $('#organization_add_edit').text('Update Organization'); // Set title to Bootstrap modal title
      }
    ...
    $.ajax({
      url : "<?php echo site_url('organizations/getcontactById/')?>" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data)
      {
...
$('.form-control').change(function(){
  ...
  function save()
  {
	 ...
	 // alert(org_name);
      var url;
      if(save_method == 'add') {
          url = "<?= site_url('organizations/create')?>";
      } else {
          url = "<?= site_url('organizations/update')?>";
      }
      // ajax adding data to database
      ...
      $.ajax({
          ...
          success: function(data)
          {
            if(data.status) //if success close modal and reload ajax table
            {
				...
				$('#billedto_select option')
                     .removeAttr('selected')
                       .filter('[value=org_name]')
                         .attr('selected', true);
				//$('#billedto_select option[value=org_name]').attr('selected','selected');
				//$('#billedto_select').val(org_name);
			...
			if(data.exist){
				$("#org_name_error").html(data.exist);
				$('#btnSave').text('save'); //change button text
                $('#btnSave').attr('disabled',true); //set button enable
			}
            if(data.st==202)
            {
              $("#org_name_error").html(data.name);
  ...
  $('#billedto_select').betterDropdown();
  });*/
</script>
<script>
$(document).ready(function(){
 ...
 $('#delete_all').click(function(){
  ...
  if(checkbox.length > 0)
  {
   ...
   $.ajax({
    url:"<?= site_url('organizations/delete_bulk')?>",
    method:"POST",
...
function putInvoiceId()
{
	...
	$.ajax({
     url: "<?= site_url(); ?>proforma_invoice/put_id_for_pi",
     method: "POST",
...
function check_invoiceNo()
{
  ...
  if(invoice_no != ''){
    $.ajax({
     url: "<?= site_url(); ?>proforma_invoice/check_invoiceduplicate",
     method: "POST",
