  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Invoice User Details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('superadmin/home'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Invoice User Details</li>
            </ol>
          </div><!-- /.col -->
        </div>
        <!-- /.row -->
    ...
    <!--<button class="btn btn-info" id="date_filter" title="Search Attendance">Filter</button>-->
           ...
           <div class="col-lg-4" style="margin-top:17px;">
		    <div class="col-md-6 mb-3">
                <select class="form-control" name="invoice_type" id="invoice_type">
                    <option value="">Select Invoice Account Type</option>
		   ...
		   <div class="col-lg-4" style="margin-top:17px;">
		    <div class="col-md-6 mb-3">
                <select class="form-control" name="invoice_license_type" id="invoice_license_type">
                    <option value="">Select Invoice license type</option>
                    <option value="Free">Free</option>
          ...
          <div class="col-lg-12">
              <div class="refresh_button float-right">
				 ...
				 <button class="btn btn-info btn-sm"> <a href="https://invoice.team365.io/" style="color:white;"><b>Invoice</b></a></button>
              </div>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="ajax_datatable" class="table table-striped table-bordered table-responsive-lg" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                           <!-- <?php if($this->session->userdata('delete_org')=='1'):?>
                            ...
                            <th class="th-sm">Invoice license active date</th>
							<th class="th-sm">Invoice account type</th>
							<th class="th-sm">Invoice license type</th>
							<th class="th-sm">Product Type</th>
							<th class="th-sm">Paid End Date</th>
					...
					<tr>
						...
						<td><?php echo  date('d M Y',strtotime($admin['invoice_license_active_date'])); ?>
						</td>
						<td><?php echo $admin['invoice_account_type']; ?></td>
						<td><?php echo $admin['invoice_license_type']; ?></td>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title" id="organization_add_edits">Invoice User details</h3>
        ...
        <div class="modal-body form">
          <form id="view" class="row" action="#">
           ...
           <!-- <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <b class="text-secondary">Invoice Account Type:</b><h6 class="text-primary"><?=$admin['invoice_account_type']; ?></h6>
            </div>
			<div class="col-sm-6">
              <b class="text-secondary">Invoice License Type:</b><h6 class="text-primary"><?=$admin['invoice_license_type']; ?></h6>
            </div>
			 <div class="col-sm-6">
			...
			<?php
             ...
             <div class="col-sm-4">
			  ...
			  <button><a href="<?php echo base_url('superadmin/view_invoiceDetails/'.$admin['id']); ?>" style="color:black;" >View User</a></button>
...
$(document).ready(function () {
    <?php //if($this->session->userdata('superretrieve_org')=='1'): ?>
        ...
        table = $('#ajax_datatable').DataTable({
              ...
              "ajax": {
                  "url": "<?= base_url('superadmin/home/ajax_list_invoice')?>",
                  "type": "POST",
                  "data" : function(data)
                  {
					  ...
					  data.invoice_license_type = $('#invoice_license_type').val();
                  }
              },
		...
		$('#invoice_license_type').change(function(){
           table.ajax.reload();
        });
    <?php //endif; ?>
});
