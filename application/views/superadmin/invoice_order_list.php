  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Invoice Order List Details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('superadmin/home'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Invoice Order List Details</li>
            </ol>
          </div><!-- /.col -->
        </div>
        <!-- /.row -->
                    ...
                    <thead>
                        <tr>
                           <!-- <?php if($this->session->userdata('delete_org')=='1'):?>
							...
							<th class="th-sm">Company Email</th>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title" id="organization_add_edits">Invoice Order List Details</h3>
        ...
        <div class="modal-body form">
          <form id="view" class="row" action="#">
            ...
            <div class="col-sm-6">
              <b class="text-secondary">Order id:</b>
			  <h6 class="text-primary" ><?=$admin['order_id'] ?></h6>
			  
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Payment id:</b><h6 class="text-primary"><?=$admin['payment_id'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Transaction id:</b><h6 class="text-primary" ><?=$admin['trans_id'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">User Name:</b><h6 class="text-primary"><?=$admin['user_name'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Company Name:</b><h6 class="text-primary" id="mobile"><?=$admin['company_name'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Company Email:</b><h6 class="text-primary"><?=$admin['company_email'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Mobile Number:</b><h6 class="text-primary"><?=$admin['user_mobile'] ?></h6>
            </div>
			<div class="col-sm-6">
              <b class="text-secondary">Product Name:</b><h6 class="text-primary"><?php 
			  if($admin['product_name']=="Team365_invoice"){
		           echo "Team365 invoice";
	                }else{
                  echo"";
                  }
			  ?>
            ...
            <div class="col-sm-6">
              <b class="text-secondary">Licence Type:</b><h6 class="text-primary"><?=$admin['licence_type'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Licence Duration:</b><h6 class="text-primary"><?=$admin['licence_duration'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Price Per Licence:</b><h6 class="text-primary"><?=$admin['price_per_licence'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Total Licence:</b><h6 class="text-primary"><?=$admin['total_licence'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Total Price:</b><h6 class="text-primary"><?=$admin['total_price'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Total Gst:</b><h6 class="text-primary"><?=$admin['total_gst'] ?></h6>
            </div>
            <div class="col-sm-6">
              <b class="text-secondary">Final Price:</b><h6 class="text-primary"><?=$admin['final_price']; ?></h6>
            </div>
			 <div class="col-sm-6">
              <b class="text-secondary">Payment Method:</b><h6 class="text-primary"><?=$admin['payment_method']; ?>
             </h6>
            </div>
			<div class="col-sm-6">
              <b class="text-secondary">Payment Status:</b><h6 class="text-primary"> <?php
			   if($admin['payment_status']==0){
		       echo "<span style='color:red;'>payment failed</span>";
	         }elseif($admin['payment_status']==1){
		         echo "<span style='color:green;'>Payment successully</span>";
	  }?></h6>
            </div>
...
$(document).ready(function () {
    <?php //if($this->session->userdata('superretrieve_org')=='1'): ?>
        ...
        table = $('#ajax_datatable').DataTable({
              ...
              "ajax": {
                  "url": "<?= base_url('superadmin/home/ajax_list_invoice_order_list')?>",
                  "type": "POST",
                  "data" : function(data)
                  {
