  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">CRM Order List Details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('superadmin/home'); ?>">Home</a></li>
              <li class="breadcrumb-item active">CRM Order List Details</li>
            </ol>
          </div><!-- /.col -->
        </div>
        <!-- /.row -->
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title" id="organization_add_edits">CRM Order List Details</h3>
        ...
        <div class="modal-body form">
          <form id="view" class="row" action="#">
			...
			<div class="col-sm-6">
			  ...
			  if($admin['product_name']=="Team365_CRM"){
		           echo "Team365 CRM";
	                }else{
                  echo"";
                  }
            ...
            <div class="col-sm-6">
			 ...
			 <div class="col-sm-6">
              <b class="text-secondary">Payment Method:</b><h6 class="text-primary"><?=$admin['payment_method']; ?></h6>
            </div>
			<div class="col-sm-6">
...
$(document).ready(function () {
    <?php //if($this->session->userdata('superretrieve_org')=='1'): ?>
        ...
        table = $('#ajax_datatable').DataTable({
              ...
              "ajax": {
                  "url": "<?= base_url('superadmin/home/ajax_list_order_list')?>",
                  "type": "POST",
                  "data" : function(data)
                  {
