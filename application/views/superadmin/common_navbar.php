...
<head>
  ...
  <?php 
	...
	else if($url == 'user_details') { $title = 'CRM User Details'; }
	else if($url == 'crm_order_details') { $title = 'CRM Order Details'; }
	else if($url == 'invoice_details') { $title = 'Invoice User Details'; }
	else if($url == 'invoice_order_details') { $title = 'Invoice Order Details'; }
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            <a href="<?php echo base_url()."superadmin/crm_order_details"; ?>" class="nav-link <?php if($page=='user_details'){ echo "activeli"; } ?>">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url()."superadmin/invoice_details"; ?>" class="nav-link <?php if($page=='invoice_details'){ echo "activeli"; } ?>">
		  ...
		  <li class="nav-item has-treeview">
            <a href="<?php echo base_url()."superadmin/invoice_order_details"; ?>" class="nav-link <?php if($page=='invoice_order_list'){ echo "activeli"; } ?>">
			  <i class="nav-icon fas fa-file-invoice"></i>
              <p>
               Invoice Order List Details
              </p>
            </a>
          </li>
		  <li class="nav-item has-treeview">
