                ...
                <div class="form-row d-flex align-items-end">
                    ...
                    <div class="col pr-1">
                      <div class="form-group">
                          ...
                          <select class="form-control type-select" name="mass_name" id="mass_name" required>
                            ...
                            <option value="subscr_type"> Subscription Type </option>
                          
                            <option value="renewal_date"> Renewal Date With Calendar </option>
                            <!-- <option value="datetime"> Added Date </option>  -->
                    ...
                    <div class="col pl-1 length-wrapper" style="display: none;">
                      <div class="form-group">
                          ...
                          <input type="date" class="form-control datetime-select" id="datetime_select" placeholder="select date" style="display: none;"> 
  ...
  <div class="content-wrapper" style="background-color:rgba(240,240,246,0.8);overflow-x:clip;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Subscription Purchase Order</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
////////////////////////////////////////////// it triggers automatically when page load (starts)///////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////// it triggers automatically when page load (ends)///////////////////////////////////////////////////////////
...
$(document).ready(function () {
  ...
  <?php if(check_permission_status('Purchase Order','retrieve_u')==true):?>
    ...
    table = $('#ajax_datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('purchaseorders/subscrpo_ajax_list/1')?>",
            "type": "POST",
            "data" : function(data)
             {  
...
<script>
  const typesRequiringLength = [
    'subject','owner','subscr_type','renewal_date','datetime','customer_company_name','customer_name','customer_email','customer_mobile','microsoft_lan_no','customer_address',
  ...
  document.addEventListener('change', function (e) {
    if (e.target.matches('.type-select')) {
      ...
      const datetimeSelect = wrapper.querySelector('.datetime-select'); 
      ...
      if (typesRequiringLength.includes(selectedType)) {
        ...
        if (selectedType === 'renewal_date') { 
          ...
          datetimeSelect.style.display = 'block';
  ...
  $('#massUpdateBtn').click(function (event) {
    ...
    if (selectedType === 'renewal_date') { 
      ...
      finalValue = $('#datetime_select').val();
    }else if (selectedType === 'payment_terms') {
