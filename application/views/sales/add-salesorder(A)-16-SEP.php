		...
		{ 
			$initialEstimatePurchase=explode("<br>",$record['initial_estimate_purchase_price']); 
				...
				?>
                  <tr class="removCL<?=$rw;?>">
                     <td>
                         <select name="salesorder_item_type[]" id="salesorder_item_type" class="form-control">
  ...
  <div class="form-footer-section py-5">
	...
	<div class="container">
		<div class="col-lg-12 mb-3 pb-2">
			<h6><a id="addEndCust" data-toggle="collapse" href="#multiCollapseExample1" class="sub-icn-so" ><!--<i class="far fa-user"></i>-->
			<img src="https://img.icons8.com/bubbles/26/000000/gender-neutral-user.png">
			Add End Customer Details</a></h6>
		</div>
