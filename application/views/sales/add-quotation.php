               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="owner" placeholder="Quote Owner" value="<?php if (isset($record['owner'])) {echo $record['owner'];  } else {   echo $this->session->userdata('name');
                  ...
                  <div class="col-lg-6">
                     <div class="form-group">
                        ...
                        <select class="form-control orgContact checkvl" name="contact_name" id="contact_name" style="width: 496.5px;">
                           ...
                           <?php } ?>
                           <option value="<?php if (isset($record['contact_name'])) { echo $record['contact_name'];
                                          }  ?>" selected=""><?php if (isset($record['contact_name'])) {echo $record['contact_name']; }  ?></option>
                        ...
                        <div class="proforma-table">
                           <table class="table table-responsive-lg" width="100%" id="add_new_line">
                              ...
                              ?>
                                    <tr class="removCL<?= $rw; ?>">   
                                    <td>
                                          <select name="quote_item_type[]" id="quote_item_type" class="form-control" style="padding:0px;width:70px;">
                                       ...
                                       <td class="gst">
                                          ...
                                          <input type="text" name="gst[]" class="form-control checkvl" onkeyup="calculate_pro_price()" id="gst<?= $rw; ?>" placeholder="GST in %" value="<?= (isset($record['pro_gst'])) ? $record['pro_gst'] : null;?>" list="taxName">
