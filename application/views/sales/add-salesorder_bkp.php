               ...
               <?php 
				...
				?>
                  <tr class="removCL<?=$rw;?>">
					...
					<td><input type="text" onkeyup="calculate_pro_price()" name="estimate_purchase_price[]"   class="form-control start checkvl price_float"  placeholder="Estimate Price" value="<?php if(isset($estimatePurchase[$pr])){ echo $estimatePurchase[$pr]; } ?>"></td> 
				...
				<tr class="removCL<?=$rw;?>">
                    ...
                    <td><input type="text" class="start form-control" onkeyup="calculate_pro_price()" name="unit_price[]" id="price<?=$rw;?>" class="form-control start checkvl price_float" id="unit_price" placeholder="rate" value=""><span id="unit_price_error"></span></td> 
					...
					<td><input type="text" onkeyup="calculate_pro_price()" name="estimate_purchase_price[]"   class="form-control start checkvl price_float"  placeholder="Estimate Price" ></td> 
...
function calculate_pro_price()
{
	...
	if(TotalMargin>0 || TotalMargin==0){
		...
		$("#ptMargin").html(numberToIndPrice(0));
		$("#userProfit").val(0);
	}
...
var rowid=400;	
	$(".add_line").click(function()
    {
	  ...
	  i++;
	  rowid++;
     var markup = '<tr class="removCL'+i+'" ><td><input type="hidden" name="product_Id[]" id="proId'+rowid+'" value="'+i+'"><input type="text" name="product_name[]" class="form-control productItm checkvl" id="proName'+rowid+'" data-cntid="'+rowid+'" onkeyup="getproductinfo();" placeholder="Items name(required)"><span id="items_error"></span></td>'+
      ...
      '<td><input type="text" name="unit_price[]"  id="price'+rowid+'" class="form-control start checkvl price_float" onkeyup="calculate_pro_price()" placeholder="rate"><span id="unit_price_error"></td>'+ 
