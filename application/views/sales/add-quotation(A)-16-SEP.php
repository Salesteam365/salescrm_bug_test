...
<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark text-right" style="-webkit-text-fill-color: unset;"><?php if(isset($action['data']) && $action['data']=='update'){ echo "Update"; }else{ echo "Add"; } ?> Quote Form</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active"><?php if(isset($action['data']) && $action['data']=='update'){ echo "Update"; }else{ echo "Add"; } ?>  Quotation</li>
               </ol>
            </div>
            <!-- /.col -->
         </div>
      ...
      <div class="form-proforma">
         <div class="container">
            <div class="row">
               ...
               <input type="hidden"  name="id"  id="id" value="<?php if(isset($record['id']) &&  $action['from']=='quotation'){ echo $record['id']; }  ?>">
               <input type="hidden"  name="lead_id"  id="lead_id" value="<?php if(isset($record['id']) && $action['from']=='opportunity' ){ echo $record['id']; }  ?>">
               ...
               <div class="col-lg-6">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control " name="opportunity_id" id="opportunity_id" value="<?php if(isset($record['opportunity_id'])){ echo $record['opportunity_id']; }  ?>" placeholder="Opportuntiy ID">
               ...
               <div class="col-lg-6">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="owner" placeholder="Quote Owner"  value="<?php if(isset($record['owner'])){ echo $record['owner']; }else{ echo $this->session->userdata('name'); }?>" readonly >
               ...
               <div class="col-lg-6">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control checkvl" name="subject" id="subject" value="<?php if(isset($record['subject'])){ echo $record['subject']; }  ?>" placeholder="Quote Subject">
                     <span id="name_error"></span>
                  </div>
               </div>
               <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control orgEmail checkvl" name="email" placeholder="Enter Customer Email." id="email" value="<?php if(isset($record['email'])){ echo $record['email']; }  ?>">
               ...
               <div class="col-lg-6">
                  ...
                  <div class="form-group">
                     ...
                     <select class="form-control checkvl" name="quote_stage" id="quote_stage">
                        ...
                        <option value="Draft" <?php if($dataSts=='Draft'){ echo "selected"; } ?> >Draft</option>
                        <option value="Negotiation" <?php if($dataSts=='Negotiation'){ echo "selected"; } ?> >Negotiation</option>
                        <option value="Delivered" <?php if($dataSts=='Delivered'){ echo "selected"; } ?> >Delivered</option>
                        <option value="On Hold" <?php if($dataSts=='On Hold'){ echo "selected"; } ?> >On Hold</option>
                        <option value="Confirmed" <?php if($dataSts=='Confirmed'){ echo "selected"; } ?> >Confirmed</option>
               ...
               <div class="col-lg-6">
                  ...
                  <div class="form-group">
                     ...
                     <select class="form-control" name="carrier" id="carrier">
                        ...
                        <?php } ?>
                        <option value="other" <?php if (!in_array($dataCr, $crrArr) && $action['data']=='update'){ echo "selected"; } ?> >other</option>
                     </select>
                     <span id="invoice_no_error"></span>
                  </div>
               </div>
               <div class="col-lg-6" style="<?php if (!in_array($dataCr, $crrArr) && $action['data']=='update'){  }else{ echo "display:none;"; } ?>" id="dispCourier">
                  <?php 
                     if(isset($record['carrier'])){ 
                     	$dataCr=$record['carrier']; 
                     }else{ 
               ...
               <div class="row">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                     ...
                     <ul class="list-inline hide_gst_checkbox">
                        ...
                        <li class="list-inline-item">
                           <label><input type="radio" name="type" value="Instate" id="csgst_checked" <?php if(isset($record['Instate']) && $record['Instate']=='Interstate'){ echo "checked"; } ?>> CGST & SGST</label>
                        </li>
                     </ul>
                  </div>
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                     <div class="proforma-table">
                        <table class="table table-responsive-lg" width="100%" id="add_new_line" >
                           ...
                           <tr class="removCL<?=$rw;?>">
                              ...
                              <td>
                                 <input type="text" name="sku[]" class="form-control" id="sku<?=$rw;?>" placeholder="SKU"  value="<?php if(isset($hsn_sac[$pr])){ echo $hsn_sac[$pr]; } ?>" >
                              </td>
                              <td class="gst">
                              ...
                              <td><input type="text" onkeyup="calculate_pro_price()" name="discount_price[]" id="disc<?=$rw;?>" class="form-control parseFloat"  placeholder="Discount Price" value="<?php if(isset($proDiscount[$pr])){ echo $proDiscount[$pr]; }else{ echo "0"; } ?>"></td>
                           ...
                           <tr class=" <?php if(empty($proDescription[$pr])){ ?> pro_descrption <?php } ?>  removCL<?=$rw;?> addCL<?=$rw;?>" <?php if(empty($proDescription[$pr])){ ?> style="display:none;" <?php } ?> >
                              <td colspan="8">
                                 <input type="text" name="pro_description[]" value="<?php if(isset($proDescription[$pr])){ echo htmlspecialchars($proDescription[$pr]); }?>"  placeholder="Description">
                              </td>
                           </tr>
                           <tr class="removCL<?=$rw;?>">
