                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                        <ul class="list-group list-group-horizontal">
                             <li class="list-group-item text-center"><a href="<?=base_url('proforma_invoice');?>"><div><img src="https://img.icons8.com/ultraviolet/18/000000/circled-left.png"></div>Back</a>
                            </li>
							<?php if(check_permission_status('Proforma Invoice','update_u')==true){ ?>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>proforma_invoice/create_newProforma/<?=$record['id']?>"><div><img src="https://img.icons8.com/cotton/18/000000/edit--v1.png"></div>Edit Invoice</a>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="right-buttons d-flex justify-content-end">
                        <ul class="list-group list-group-horizontal">
                            ...
                            <li class="list-group-item text-center"><a href="<?=base_url();?>proforma_invoice/generate_pdf?pi=<?=$_GET['pi'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>" target="_blank"><div><img src="https://img.icons8.com/color/18/000000/print.png"/></div>Print</a>
                            </li>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>proforma_invoice/generate_pdf?pi=<?=$_GET['pi'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>&dn=1" target="_blank"><div><img src="https://img.icons8.com/fluent/20/000000/download.png"/></div>Download</a>
                            </li>
    ...
    <div id="main" class="content">
        <div class="container-fluid">
            <div class="accordion" id="faq">
                <div class="card">
                    <div class="card-header" id="faqhead1"> <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1"><i class="fas fa-file-alt"></i> Quick Proforma Invoice Detail</a>
                    </div>
          ...
          <div class="row">
			...
			<div class="col-md-6">
			 <div class="row text-center " style="padding-top: 5%;">
			  ...
			  <div class="col-md-4">
			   <?php $actual_link = base_url()."proforma_invoice/generate_pdf?pi=".$_GET['pi']."&cnp=".$_GET['cnp']."&ceml=".$_GET['ceml']; ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding: 5%;">
          <div class="row" id="formDiv">
			...
			<div class="col-md-10">
			  <input type="text" class="form-control onlyLetters" value="<?=$record['billedto_orgname'];?>" name="orgName" id="orgName">
            </div>
			<div class="col-md-2 lbl">
			...
			<div class="col-md-10">
			  <input type="text" class="form-control" value="Proforma Invoice For <?=$record['billedto_orgname'];?> - #<?=$record['invoice_no'];?>" name="subEmail" id="subEmail">
            </div>
			...
			<div class="col-md-12">
			  <textarea class="form-control" id="descriptionTxt"   name="descriptionTxt">
				<p>Hi <?=$record['billedto_orgname'];?>,</p>
				<p>Please find attached proforma invoice #<?=$record['invoice_no'];?>.</p>
				<p>Invoice No: #<?=$record['invoice_no'];?></p>
				<p>Billed To: <?=$record['billedto_orgname'];?></p>
...
function share() { 
            ...
            var message =  "<?php echo base_url();?>proforma_invoice/generate_pdf?pi=<?=$_GET['pi']?>&cnp=<?=$_GET['cnp']?>&ceml=<?=$_GET['ceml']?>"; 
...
$("#sendEmail").click(function(){
	...
	//alert(piid);
		//alert(compeml);
			//alert(compname);
	var invoiceurl="<?php echo base_url();?>proforma_invoice/generate_pdf?pi=<?=$_GET['pi']?>&cnp=<?=$_GET['cnp']?>&ceml=<?=$_GET['ceml']?>";
	var descriptionTxt = CKEDITOR.instances["descriptionTxt"].getData();
	$.ajax({
     url: "<?= site_url(); ?>proforma_invoice/send_email",
     method: "POST",
     ...
     success: function(dataSucc){
      ...
      if(dataSucc==1){
			...
			$("#messageDiv").html('<i class="far fa-check-circle" style="color: #60b963; font-size: 42px;"></i><br>Your proforma invoice shared successfully.');
			$("#messageDiv").css('display','block');
			$("#sendEmail").html('Send Email');
			setTimeout(function(){ $("#messageDiv").hide(); $("#formDiv, #footerDiv").show(); $('#emailModel').modal('hide'); },4000)
	  }else{
		  $("#formDiv, #footerDiv").hide();
		  $("#messageDiv").html('<i class="fas fa-exclamation-triangle" style="color:#e617089e; font-size: 42px;"></i><br>Your proforma invoice shared failed.');
		  $("#messageDiv").css('display','block');
		  $("#sendEmail").html('Send Email');
