                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                        <ul class="list-group list-group-horizontal">
							...
							<a href="<?=base_url('invoices');?>"><div><img src="https://img.icons8.com/ultraviolet/18/000000/circled-left.png"></div>Back</a>
                            </li>
							<?php if($this->session->userdata('update_pi')=='1'): ?>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>invoices/edit-invoice/<?=$record['id']?>"><div><img src="https://img.icons8.com/cotton/18/000000/edit--v1.png"></div>Edit Invoice</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="right-buttons d-flex justify-content-end">
                        <ul class="list-group list-group-horizontal">
						    ...
						    <li class="list-group-item text-center"><a href="<?=base_url();?>invoices/generate-pdf?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>" target="_blank"><div><img src="https://img.icons8.com/color/18/000000/print.png"/></div>Print</a>
                            </li>
                            <li class="list-group-item text-center"><a href="<?=base_url();?>invoices/generate-pdf?inv_id=<?=$_GET['inv_id'];?>&cnp=<?=$_GET['cnp'];?>&ceml=<?=$_GET['ceml'];?>&dn=1" target="_blank"><div><img src="https://img.icons8.com/fluent/20/000000/download.png"/></div>Download</a>
                            </li>
    ...
    <div id="main" class="content">
        <div class="container-fluid">
            <div class="accordion" id="faq">
                <div class="card">
                    <div class="card-header" id="faqhead1"> <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1" style="background:rgba(230,242,255,0.4); color:black;"><!--<i class="fas fa-file-alt"></i>--> <img src="https://img.icons8.com/plasticine/24/000000/invoice-1.png"/>Quick Invoices Detail</a>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <p>₹ <?=IND_money_format($record['sub_total']);?></p>
                                </div>
                                <div class="col">
                                    <b>Invoice Date</b>
									<?php 
               ...
               <div class="card">
                    <div class="card-header" id="faqhead2"> <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="true" aria-controls="faq2" style="background:rgba(230,242,255,0.4); color:black;"><!--<i class="fas fa-university"></i>--> <img src="https://img.icons8.com/ultraviolet/24/000000/bank-building.png" style="margin-bottom:4px;"> Bank And UPI Detail</a>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="faqhead3"> <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq3" aria-expanded="true" aria-controls="faq3" style="background:rgba(230,242,255,0.4); color:black;"><!--<i class="fab fa-cc-visa"></i>--><img src="https://img.icons8.com/dusk/24/000000/online-payment-.png"/> Online Payment Options</a>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="faqhead4"> 
						<a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq4" aria-expanded="true" aria-controls="faq4" style="background:rgba(230,242,255,0.4); color:black;">
							<img src="https://img.icons8.com/dusk/24/000000/payment-history.png"/>&nbsp;&nbsp;Payment History</span>
						</a>
                    </div>
                    <div id="faq4" class="collapse" aria-labelledby="faqhead4" data-parent="#faq">
                        <div class="card-body">
						<div class="row d-flex justify-content-end">
							<button onclick="updateaccept('<?=$record['id'];?>')" class="btn btn-info mb-3"> <img src="https://img.icons8.com/cotton/24/000000/add-dollar--v2.png"/> &nbsp;&nbsp;Accept Payment</button>
						</div>
						<div class="row">
    ...
    <div class="invoice-type">
        <div class="container">
            ...
            <div class="row mt-3">
				...
				<?php if(isset($record['saleorder_id']) && $record['saleorder_id']!=""){?>
					<p>Sales Order ID</p>
				<?php } ?> 
                    <p>Invoice No#</p>
                    <p>Invoice Date</p>
            ...
            <div class="invoice-table mt-3 text-left">
                ...
                <table class="table table-responsive-lg">
                    ...
                    $discount = explode("<br>",$record['pro_discount']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                        <div class="bank-total-right">
							...
							<?php }else if($record['type']=="Instate"){?>
                            <div class="row">
                                <div class="col">
                                    SGST
                                </div>
							...
							<?php } ?>
							<?php  if($record['extra_charge_value']!=""){ 
							$extraCharge_name=explode("<br>",$record['extra_charge_label']);
							$extraCharge_value=explode("<br>",$record['extra_charge_value']);
			...
			<div class="terms-condition">
				<div class="row">
					...
					<div class="col">
						<div class="details-switch">
							<label class="switch">
								<input type="checkbox" id="slider_declaration" onchange="enable_declaration('<?=$record['id'];?>')" name="slider_declaration" <?php if($record['declaration_status']==1){ echo "checked"; } ?> >
				...
				<div class="row">
					<?php if($record['invoice_declaration']!=""){ echo $record['invoice_declaration']; } ?>
				</div>
			...
			<div class="terms-condition">
                <p><b>Note :-</b> </p>
				<?php if($record['notes']!=""){ echo $record['notes']; } ?>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form">
                  <form action="#" id="payment_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                    <input type="hidden"  name="sales_id" id="sales_id" value="<?php echo $record['saleorder_id'];?>" >
