            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="left-buttons">
                        <ul class="list-group list-group-horizontal">
                             <li class="list-group-item"><a href="<?=base_url('purchaseorders');?>"><i class="fas fa-arrow-circle-left"></i>Back</a>
                            </li>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="right-buttons">
                        <ul class="list-group list-group-horizontal">
						<?php if($this->session->userdata('type') == 'admin' || $record['approve_status']=='1'){ ?>
                             <li class="list-group-item"><a href="<?=base_url();?>purchaseorders/view/<?=$record['id']?>" target="_blank"><i class="fas fa-print"></i>Print</a>
                            </li>
                            <li class="list-group-item"><a href="<?=base_url();?>purchaseorders/view/<?=$record['id']?>/dn" target="_blank"><i class="fas fa-download"></i>Download</a>
                            </li>
    ...
    <div id="main" class="content">
        <div class="container-fluid">
            <div class="accordion" id="faq">
                <div class="card">
                    <div class="card-header" id="faqhead1"> <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1"><i class="fas fa-file-alt"></i> Quick Purchaseorder Detail</a>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="faqhead7"> <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq7" aria-expanded="true" aria-controls="faq7"><i class="fas fa-link"></i> Linked Purchaseorders <span class="paid-btn">Created</span></a>
                    </div>
          ...
          <div class="row" id="formDiv">
			...
			<div class="col-md-12">
			  <textarea class="form-control" id="descriptionTxt"   name="descriptionTxt">
				...
				<p>Please find attached Purchaseorder #<?=$record['purchaseorder_id'];?>.</p>
				<p>Purchaseorder Id: #<?=$record['purchaseorder_id'];?></p>
