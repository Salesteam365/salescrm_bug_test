  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <a onclick="appurl('https://play.google.com/store/apps/details?id=com.team365_CRM.test_ui')"><img style="cursor: pointer" src="https://team365.io//assets/img/chrismas_offer.png"  width="100%" height="auto" title="click to install"></a>
      </div>
...
function appurl(url) {
  ...
  {
    alert('Please Open this website on any android device for intallation.');
  }
