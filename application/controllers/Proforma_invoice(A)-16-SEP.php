	...
	$signature_img='';	
	 ...
	 if($upload_signature !== ''){		 
        ...
        if (!$this->upload->do_upload('upload_signature')) {
            echo json_encode(array('error_uploadsignature' => $this->upload->display_errors(), 'st'=>'error_fileupload'));die;
	  ...
	  if($attachment !== '')
	  {
        ...
        if (!$this->upload->do_upload('attachment')) {
            echo json_encode(array('error_attachment' => $this->upload->display_errors(), 'st'=>'error_fileupload'));die;
