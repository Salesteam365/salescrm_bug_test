	...
	public function create()
	{
		...
		if ($validation !== 200) {
			...
			if ($planDetail['plan_licence'] > $planDetail['used_licence']) {
				...
				$type = "standard";
				$product_type = "CRM";
				$data = array('standard_name' => $standard_name, 'sub_domain' => $this->session->userdata('sub_domain'), 'standard_email' => $this->input->post('standard_email'), 'standard_mobile' => $this->input->post('standard_mobile'), 'standard_password' => md5($this->input->post('standard_password')), 'your_plan_id' => $this->input->post('license_type'), 'admin_name' => $this->session->userdata('name'), 'type' => $type, 'product_type' => $product_type, 'role_id' => $this->input->post('sel_role'), 'reports_to' => $this->input->post('reports_to'), 'user_type' => $this->input->post('user_type'), 'account_type' => $this->session->userdata('account_type'), 'company_name' => $this->session->userdata('company_name'), 'country' => $this->session->userdata('country'), 'state' => $this->session->userdata('state'), 'city' => $this->session->userdata('city'), 'company_address' => $this->session->userdata('company_address'), 'zipcode' => $this->session->userdata('zipcode'), 'company_mobile' => $this->session->userdata('company_mobile'), 'company_email' => $this->session->userdata('company_email'), 'company_website' => $this->session->userdata('company_website'), 'company_gstin' => $this->session->userdata('company_gstin'), 'pan_number' => $this->session->userdata('pan_number'), 'cin' => $this->session->userdata('cin'), 'status' => 1, 'company_logo' => $this->session->userdata('company_logo'), 'terms_condition_customer' => $this->session->userdata('terms_condition_customer'), 'terms_condition_seller' => $this->session->userdata('terms_condition_seller'),);
		...
		<table class="main">
			...
			<tbody>
				...
				<td> : </td>
				<td>https://' . $this->session->userdata('sub_domain') . '.team365.io/</td>
				</tr>
				<tr>
	...
	public function update()
	{
		...
		if ($validation != 200) {
			...
			if ($planId == $planIdhidden || $planDetail['plan_licence'] > $planDetail['used_licence']) {
				$data = array('id' => $this->input->post('update_id'), 'role_id' => $this->input->post('sel_role'), 'reports_to' => $this->input->post('reports_to'), 'user_type' => $this->input->post('user_typeUpdate'), 'standard_name' => $this->input->post('standard_name'), 'standard_email' => $this->input->post('standard_email'), 'standard_mobile' => $this->input->post('standard_mobile'), 'your_plan_id' => $this->input->post('sel_lic_type'), 'country' => $this->input->post('country'), 'state' => $this->input->post('state'), 'city' => $this->input->post('city'), 'zipcode' => $this->input->post('zipcode'), 'create_org' => $this->input->post('create_org'), 'retrieve_org' => $this->input->post('retrieve_org'), 'update_org' => $this->input->post('update_org'), 'delete_org' => $this->input->post('delete_org'), 'create_contact' => $this->input->post('create_contact'), 'retrieve_contact' => $this->input->post('retrieve_contact'), 'update_contact' => $this->input->post('update_contact'), 'delete_contact' => $this->input->post('delete_contact'), 'create_lead' => $this->input->post('create_lead'), 'retrieve_lead' => $this->input->post('retrieve_lead'), 'update_lead' => $this->input->post('update_lead'), 'delete_lead' => $this->input->post('delete_lead'), 'create_opp' => $this->input->post('create_opp'), 'retrieve_opp' => $this->input->post('retrieve_opp'), 'update_opp' => $this->input->post('update_opp'), 'delete_opp' => $this->input->post('delete_opp'), 'create_quote' => $this->input->post('create_quote'), 'retrieve_quote' => $this->input->post('retrieve_quote'), 'update_quote' => $this->input->post('update_quote'), 'delete_quote' => $this->input->post('delete_quote'), 'create_so' => $this->input->post('create_so'), 'retrieve_so' => $this->input->post('retrieve_so'), 'update_so' => $this->input->post('update_so'), 'delete_so' => $this->input->post('delete_so'), 'create_vendor' => $this->input->post('create_vendor'), 'retrieve_vendor' => $this->input->post('retrieve_vendor'), 'update_vendor' => $this->input->post('update_vendor'), 'delete_vendor' => $this->input->post('delete_vendor'), 'create_po' => $this->input->post('create_po'), 'retrieve_po' => $this->input->post('retrieve_po'), 'update_po' => $this->input->post('update_po'), 'delete_po' => $this->input->post('delete_po'), 'create_inv' => $this->input->post('create_inv'), 'retrieve_inv' => $this->input->post('retrieve_inv'), 'update_inv' => $this->input->post('update_inv'), 'delete_inv' => $this->input->post('delete_inv'), 'create_pi' => $this->input->post('create_pi'), 'retrieve_pi' => $this->input->post('retrieve_pi'), 'update_pi' => $this->input->post('update_pi'), 'delete_pi' => $this->input->post('delete_pi'), 'pending_payment_mail' => $this->input->post('pendingPayment'), 'accept_payment_mail' => $this->input->post('acceptMail'), 'so_approve_mail' => $this->input->post('approveMail'), 'so_approval' => $this->input->post('approveSO'), 'po_approval' => $this->input->post('approvePO'), 'notapprovalSO' => $this->input->post('notapproveSO'), 'notapprovalPO' => $this->input->post('notapprovePO'),);
